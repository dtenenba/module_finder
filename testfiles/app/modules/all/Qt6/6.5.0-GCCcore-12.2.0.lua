...
local root = "/app/software/Qt6/6.5.0-GCCcore-12.2.0"
...
setenv("EBVERSIONQT6", "6.5.0")
setenv("EBDEVELQT6", pathJoin(root, "logs/Qt6-6.5.0-GCCcore-12.2.0-easybuild-devel"))
