...
local root = "/app/software/HarfBuzz/8.2.2-GCCcore-13.2.0"
...
setenv("EBVERSIONHARFBUZZ", "8.2.2")
setenv("EBDEVELHARFBUZZ", pathJoin(root, "logs/HarfBuzz-8.2.2-GCCcore-13.2.0-easybuild-devel"))
