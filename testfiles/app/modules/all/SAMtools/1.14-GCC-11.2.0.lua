...
local root = "/app/software/SAMtools/1.14-GCC-11.2.0"
...
setenv("EBVERSIONSAMTOOLS", "1.14")
setenv("EBDEVELSAMTOOLS", pathJoin(root, "logs/SAMtools-1.14-GCC-11.2.0-easybuild-devel"))
