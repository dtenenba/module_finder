...
local root = "/app/software/PLINK2/20210701-linux_x86_64"

conflict("PLINK2")

prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTPLINK2", root)
setenv("EBVERSIONPLINK2", "20210701")
setenv("EBDEVELPLINK2", pathJoin(root, "logs/PLINK2-20210701-linux_x86_64-easybuild-devel"))
