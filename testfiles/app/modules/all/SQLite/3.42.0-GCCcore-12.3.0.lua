...
local root = "/app/software/SQLite/3.42.0-GCCcore-12.3.0"
...
setenv("EBVERSIONSQLITE", "3.42.0")
setenv("EBDEVELSQLITE", pathJoin(root, "logs/SQLite-3.42.0-GCCcore-12.3.0-easybuild-devel"))
