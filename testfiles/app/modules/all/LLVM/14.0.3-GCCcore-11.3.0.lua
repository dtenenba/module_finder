...
local root = "/app/software/LLVM/14.0.3-GCCcore-11.3.0"
...
setenv("EBVERSIONLLVM", "14.0.3")
setenv("EBDEVELLLVM", pathJoin(root, "logs/LLVM-14.0.3-GCCcore-11.3.0-easybuild-devel"))
