...
local root = "/app/software/LLVM/10.0.0-GCCcore-10.2.0"
...
setenv("EBVERSIONLLVM", "10.0.0")
setenv("EBDEVELLLVM", pathJoin(root, "logs/LLVM-10.0.0-GCCcore-10.2.0-easybuild-devel"))
