...
local root = "/app/software/LLVM/8.0.1-GCCcore-8.3.0"
...
setenv("EBVERSIONLLVM", "8.0.1")
setenv("EBDEVELLLVM", pathJoin(root, "logs/LLVM-8.0.1-GCCcore-8.3.0-easybuild-devel"))
