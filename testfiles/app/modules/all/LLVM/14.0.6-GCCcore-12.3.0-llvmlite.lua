...
local root = "/app/software/LLVM/14.0.6-GCCcore-12.3.0-llvmlite"
...
setenv("EBVERSIONLLVM", "14.0.6")
setenv("EBDEVELLLVM", pathJoin(root, "logs/LLVM-14.0.6-GCCcore-12.3.0-llvmlite-easybuild-devel"))
