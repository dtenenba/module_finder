...
local root = "/app/software/Clang/16.0.6-GCCcore-12.3.0"
...
if not ( isloaded("Z3/4.12.2-GCCcore-12.3.0") ) then
    load("Z3/4.12.2-GCCcore-12.3.0")
end
...
setenv("EBVERSIONCLANG", "16.0.6")
setenv("EBDEVELCLANG", pathJoin(root, "logs/Clang-16.0.6-GCCcore-12.3.0-easybuild-devel"))

setenv("ASAN_SYMBOLIZER_PATH", "/app/software/Clang/16.0.6-GCCcore-12.3.0/bin/llvm-symbolizer")
