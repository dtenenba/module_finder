...
local root = "/app/software/Clang/16.0.6-GCCcore-13.2.0"
...
if not ( isloaded("Z3/4.13.0-GCCcore-13.2.0") ) then
    load("Z3/4.13.0-GCCcore-13.2.0")
end
...
setenv("EBDEVELCLANG", pathJoin(root, "logs/Clang-16.0.6-GCCcore-13.2.0-easybuild-devel"))

setenv("ASAN_SYMBOLIZER_PATH", "/app/software/Clang/16.0.6-GCCcore-13.2.0/bin/llvm-symbolizer")
