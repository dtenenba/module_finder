...
local root = "/app/software/Clang/15.0.7-GCCcore-12.2.0"
...
if not ( isloaded("Z3/4.12.0-GCCcore-12.2.0") ) then
    load("Z3/4.12.0-GCCcore-12.2.0")
end
...
setenv("EBVERSIONCLANG", "15.0.7")
setenv("EBDEVELCLANG", pathJoin(root, "logs/Clang-15.0.7-GCCcore-12.2.0-easybuild-devel"))

setenv("ASAN_SYMBOLIZER_PATH", "/app/software/Clang/15.0.7-GCCcore-12.2.0/bin/llvm-symbolizer")
