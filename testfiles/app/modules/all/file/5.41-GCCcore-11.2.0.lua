...
local root = "/app/software/file/5.41-GCCcore-11.2.0"
...
setenv("EBVERSIONFILE", "5.41")
setenv("EBDEVELFILE", pathJoin(root, "logs/file-5.41-GCCcore-11.2.0-easybuild-devel"))
