...
local root = "/app/software/Biopython/1.77-foss-2020a-Python-3.8.2"
...
setenv("EBVERSIONBIOPYTHON", "1.77")
setenv("EBDEVELBIOPYTHON", pathJoin(root, "logs/Biopython-1.77-foss-2020a-Python-3.8.2-easybuild-devel"))
