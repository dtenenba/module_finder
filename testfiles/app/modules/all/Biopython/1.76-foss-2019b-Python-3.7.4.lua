...
local root = "/app/software/Biopython/1.76-foss-2019b-Python-3.7.4"
...
setenv("EBVERSIONBIOPYTHON", "1.76")
setenv("EBDEVELBIOPYTHON", pathJoin(root, "logs/Biopython-1.76-foss-2019b-Python-3.7.4-easybuild-devel"))
