...
Included extensions
===================
QUAST-5.1.0rc1, simplejson-3.17.2
]==])
...
whatis([==[Extensions: QUAST-5.1.0rc1, simplejson-3.17.2]==])

local root = "/app/software/QUAST/5.1.0rc1-foss-2020b"
...
setenv("EBVERSIONQUAST", "5.1.0rc1")
setenv("EBDEVELQUAST", pathJoin(root, "logs/QUAST-5.1.0rc1-foss-2020b-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.8/site-packages"))
-- Built with EasyBuild version 4.5.1
setenv("EBEXTSLISTQUAST", "simplejson-3.17.2,QUAST-5.1.0rc1")
