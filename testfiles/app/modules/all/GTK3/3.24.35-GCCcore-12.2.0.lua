...
local root = "/app/software/GTK3/3.24.35-GCCcore-12.2.0"
...
if not ( isloaded("ATK/2.38.0-GCCcore-12.2.0") ) then
    load("ATK/2.38.0-GCCcore-12.2.0")
end

if not ( isloaded("at-spi2-atk/2.38.0-GCCcore-12.2.0") ) then
    load("at-spi2-atk/2.38.0-GCCcore-12.2.0")
end
...
if not ( isloaded("libepoxy/1.5.10-GCCcore-12.2.0") ) then
    load("libepoxy/1.5.10-GCCcore-12.2.0")
end
...
setenv("EBDEVELGTK3", pathJoin(root, "logs/GTK3-3.24.35-GCCcore-12.2.0-easybuild-devel"))
