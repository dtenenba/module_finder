...
local root = "/app/software/GTK3/3.24.37-GCCcore-12.3.0"
...
if not ( isloaded("at-spi2-atk/2.38.0-GCCcore-12.3.0") ) then
    load("at-spi2-atk/2.38.0-GCCcore-12.3.0")
end
...
if not ( isloaded("libepoxy/1.5.10-GCCcore-12.3.0") ) then
    load("libepoxy/1.5.10-GCCcore-12.3.0")
end
...
if not ( isloaded("Wayland/1.22.0-GCCcore-12.3.0") ) then
    load("Wayland/1.22.0-GCCcore-12.3.0")
end
...
setenv("EBVERSIONGTK3", "3.24.37")
setenv("EBDEVELGTK3", pathJoin(root, "logs/GTK3-3.24.37-GCCcore-12.3.0-easybuild-devel"))
