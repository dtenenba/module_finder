...
local root = "/app/software/arpack-ng/3.9.0-foss-2023b"
...
if not ( isloaded("Eigen/3.4.0-GCCcore-13.2.0") ) then
    load("Eigen/3.4.0-GCCcore-13.2.0")
end
...
setenv("EBVERSIONARPACKMINNG", "3.9.0")
setenv("EBDEVELARPACKMINNG", pathJoin(root, "logs/arpack-ng-3.9.0-foss-2023b-easybuild-devel"))
