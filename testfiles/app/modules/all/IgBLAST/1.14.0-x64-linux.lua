...
local root = "/app/software/IgBLAST/1.14.0-x64-linux"

conflict("IgBLAST")

prepend_path("PATH", pathJoin(root, "bin"))
setenv("EBROOTIGBLAST", root)
setenv("EBVERSIONIGBLAST", "1.14.0")
setenv("EBDEVELIGBLAST", pathJoin(root, "logs/IgBLAST-1.14.0-x64-linux-easybuild-devel"))

setenv("IGDATA", "/app/software/IgBLAST/1.14.0-x64-linux/internal_data")
