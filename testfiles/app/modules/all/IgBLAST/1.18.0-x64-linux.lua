...
local root = "/app/software/IgBLAST/1.18.0-x64-linux"
...
setenv("EBVERSIONIGBLAST", "1.18.0")
setenv("EBDEVELIGBLAST", pathJoin(root, "logs/IgBLAST-1.18.0-x64-linux-easybuild-devel"))

setenv("IGDATA", "/app/software/IgBLAST/1.18.0-x64-linux/internal_data")
