...
local root = "/app/software/libpciaccess/0.17-GCCcore-12.3.0"
...
setenv("EBDEVELLIBPCIACCESS", pathJoin(root, "logs/libpciaccess-0.17-GCCcore-12.3.0-easybuild-devel"))
