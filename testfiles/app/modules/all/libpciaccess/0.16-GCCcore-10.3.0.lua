...
local root = "/app/software/libpciaccess/0.16-GCCcore-10.3.0"
...
setenv("EBDEVELLIBPCIACCESS", pathJoin(root, "logs/libpciaccess-0.16-GCCcore-10.3.0-easybuild-devel"))
