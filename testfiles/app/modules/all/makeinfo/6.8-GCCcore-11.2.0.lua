...
local root = "/app/software/makeinfo/6.8-GCCcore-11.2.0"
...
setenv("EBVERSIONMAKEINFO", "6.8")
setenv("EBDEVELMAKEINFO", pathJoin(root, "logs/makeinfo-6.8-GCCcore-11.2.0-easybuild-devel"))
