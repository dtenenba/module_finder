...
local root = "/app/software/MPFR/4.2.1-GCCcore-13.2.0"
...
setenv("EBVERSIONMPFR", "4.2.1")
setenv("EBDEVELMPFR", pathJoin(root, "logs/MPFR-4.2.1-GCCcore-13.2.0-easybuild-devel"))
