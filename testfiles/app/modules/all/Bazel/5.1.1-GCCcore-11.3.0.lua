...
local root = "/app/software/Bazel/5.1.1-GCCcore-11.3.0"
...
setenv("EBVERSIONBAZEL", "5.1.1")
setenv("EBDEVELBAZEL", pathJoin(root, "logs/Bazel-5.1.1-GCCcore-11.3.0-easybuild-devel"))
