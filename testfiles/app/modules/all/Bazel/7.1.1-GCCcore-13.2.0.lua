...
local root = "/app/software/Bazel/7.1.1-GCCcore-13.2.0"
...
setenv("EBVERSIONBAZEL", "7.1.1")
setenv("EBDEVELBAZEL", pathJoin(root, "logs/Bazel-7.1.1-GCCcore-13.2.0-easybuild-devel"))
