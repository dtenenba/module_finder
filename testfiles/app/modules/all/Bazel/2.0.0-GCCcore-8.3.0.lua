...
local root = "/app/software/Bazel/2.0.0-GCCcore-8.3.0"
...
setenv("EBVERSIONBAZEL", "2.0.0")
setenv("EBDEVELBAZEL", pathJoin(root, "logs/Bazel-2.0.0-GCCcore-8.3.0-easybuild-devel"))
