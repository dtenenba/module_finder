...
local root = "/app/software/Telescope/1.0.3-gfbf-2022b"
...
setenv("EBVERSIONTELESCOPE", "1.0.3")
setenv("EBDEVELTELESCOPE", pathJoin(root, "logs/Telescope-1.0.3-gfbf-2022b-easybuild-devel"))
