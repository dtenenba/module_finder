...
local root = "/app/software/ATK/2.36.0-GCCcore-11.2.0"
...
setenv("EBVERSIONATK", "2.36.0")
setenv("EBDEVELATK", pathJoin(root, "logs/ATK-2.36.0-GCCcore-11.2.0-easybuild-devel"))
