...
local root = "/app/software/fig2dev/3.2.6a-foss-2019b"
...
if not ( isloaded("xfig/3.2.6a-foss-2019b") ) then
    load("xfig/3.2.6a-foss-2019b")
end
...
setenv("EBROOTFIG2DEV", root)
setenv("EBVERSIONFIG2DEV", "3.2.6a")
setenv("EBDEVELFIG2DEV", pathJoin(root, "logs/fig2dev-3.2.6a-foss-2019b-easybuild-devel"))
