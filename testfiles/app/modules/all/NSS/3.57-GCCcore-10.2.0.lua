...
local root = "/app/software/NSS/3.57-GCCcore-10.2.0"
...
if not ( isloaded("NSPR/4.29-GCCcore-10.2.0") ) then
    load("NSPR/4.29-GCCcore-10.2.0")
end
...
setenv("EBDEVELNSS", pathJoin(root, "logs/NSS-3.57-GCCcore-10.2.0-easybuild-devel"))
