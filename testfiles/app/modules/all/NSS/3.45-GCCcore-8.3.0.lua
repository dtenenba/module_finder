...
local root = "/app/software/NSS/3.45-GCCcore-8.3.0"
...
if not ( isloaded("NSPR/4.21-GCCcore-8.3.0") ) then
    load("NSPR/4.21-GCCcore-8.3.0")
end
...
setenv("EBVERSIONNSS", "3.45")
setenv("EBDEVELNSS", pathJoin(root, "logs/NSS-3.45-GCCcore-8.3.0-easybuild-devel"))
