...
local root = "/app/software/NSS/3.51-GCCcore-9.3.0"
...
if not ( isloaded("NSPR/4.25-GCCcore-9.3.0") ) then
    load("NSPR/4.25-GCCcore-9.3.0")
end
...
setenv("EBDEVELNSS", pathJoin(root, "logs/NSS-3.51-GCCcore-9.3.0-easybuild-devel"))
