...
local root = "/app/software/NSS/3.94-GCCcore-13.2.0"
...
if not ( isloaded("NSPR/4.35-GCCcore-13.2.0") ) then
    load("NSPR/4.35-GCCcore-13.2.0")
end
...
setenv("EBVERSIONNSS", "3.94")
setenv("EBDEVELNSS", pathJoin(root, "logs/NSS-3.94-GCCcore-13.2.0-easybuild-devel"))
