...
local root = "/app/software/JupyterLab/2.2.8-GCCcore-10.2.0"
...
setenv("EBDEVELJUPYTERLAB", pathJoin(root, "logs/JupyterLab-2.2.8-GCCcore-10.2.0-easybuild-devel"))

setenv("JUPYTERLAB_DIR", "/app/software/JupyterLab/2.2.8-GCCcore-10.2.0/share/jupyter/lab")
