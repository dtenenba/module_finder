...
local root = "/app/software/Brotli/1.1.0-GCCcore-13.2.0"
...
setenv("EBVERSIONBROTLI", "1.1.0")
setenv("EBDEVELBROTLI", pathJoin(root, "logs/Brotli-1.1.0-GCCcore-13.2.0-easybuild-devel"))
