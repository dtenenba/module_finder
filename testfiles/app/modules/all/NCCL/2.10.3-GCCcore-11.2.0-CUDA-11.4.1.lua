...
local root = "/app/software/NCCL/2.10.3-GCCcore-11.2.0-CUDA-11.4.1"
...
if not ( isloaded("UCX-CUDA/1.11.2-GCCcore-11.2.0-CUDA-11.4.1") ) then
    load("UCX-CUDA/1.11.2-GCCcore-11.2.0-CUDA-11.4.1")
end
...
setenv("EBDEVELNCCL", pathJoin(root, "logs/NCCL-2.10.3-GCCcore-11.2.0-CUDA-11.4.1-easybuild-devel"))
