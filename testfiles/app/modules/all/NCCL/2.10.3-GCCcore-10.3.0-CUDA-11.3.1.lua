...
local root = "/app/software/NCCL/2.10.3-GCCcore-10.3.0-CUDA-11.3.1"
...
if not ( isloaded("UCX-CUDA/1.10.0-GCCcore-10.3.0-CUDA-11.3.1") ) then
    load("UCX-CUDA/1.10.0-GCCcore-10.3.0-CUDA-11.3.1")
end
...
setenv("EBDEVELNCCL", pathJoin(root, "logs/NCCL-2.10.3-GCCcore-10.3.0-CUDA-11.3.1-easybuild-devel"))
