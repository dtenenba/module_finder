...
local root = "/app/software/NCCL/2.8.3-GCCcore-10.2.0-CUDA-11.1.1"
...
setenv("EBDEVELNCCL", pathJoin(root, "logs/NCCL-2.8.3-GCCcore-10.2.0-CUDA-11.1.1-easybuild-devel"))
