...
local root = "/app/software/Go/1.18.1"
...
setenv("EBVERSIONGO", "1.18.1")
setenv("EBDEVELGO", pathJoin(root, "logs/Go-1.18.1-easybuild-devel"))

setenv("GOROOT", "/app/software/Go/1.18.1")
