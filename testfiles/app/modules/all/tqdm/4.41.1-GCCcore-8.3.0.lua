...
local root = "/app/software/tqdm/4.41.1-GCCcore-8.3.0"
...
setenv("EBVERSIONTQDM", "4.41.1")
setenv("EBDEVELTQDM", pathJoin(root, "logs/tqdm-4.41.1-GCCcore-8.3.0-easybuild-devel"))
