...
local root = "/app/software/tqdm/4.60.0-GCCcore-10.2.0"
...
setenv("EBVERSIONTQDM", "4.60.0")
setenv("EBDEVELTQDM", pathJoin(root, "logs/tqdm-4.60.0-GCCcore-10.2.0-easybuild-devel"))
