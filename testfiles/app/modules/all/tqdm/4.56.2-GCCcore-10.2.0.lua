...
local root = "/app/software/tqdm/4.56.2-GCCcore-10.2.0"
...
setenv("EBVERSIONTQDM", "4.56.2")
setenv("EBDEVELTQDM", pathJoin(root, "logs/tqdm-4.56.2-GCCcore-10.2.0-easybuild-devel"))
