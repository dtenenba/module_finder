...
local root = "/app/software/tqdm/4.64.0-GCCcore-11.3.0"
...
setenv("EBVERSIONTQDM", "4.64.0")
setenv("EBDEVELTQDM", pathJoin(root, "logs/tqdm-4.64.0-GCCcore-11.3.0-easybuild-devel"))
