...
local root = "/app/software/VEP/103.1-GCC-10.2.0"
...
if not ( isloaded("Archive-Zip/1.68-GCCcore-10.2.0") ) then
    load("Archive-Zip/1.68-GCCcore-10.2.0")
end
...
setenv("EBDEVELVEP", pathJoin(root, "logs/VEP-103.1-GCC-10.2.0-easybuild-devel"))
