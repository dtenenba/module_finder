...
local root = "/app/software/HH-suite/3.3.0-gompi-2022a"
...
setenv("EBDEVELHHMINSUITE", pathJoin(root, "logs/HH-suite-3.3.0-gompi-2022a-easybuild-devel"))

setenv("HHLIB", "/app/software/HH-suite/3.3.0-gompi-2022a")
