...
local root = "/app/software/Xerces-C++/3.2.4-GCCcore-12.2.0"
...
setenv("EBDEVELXERCESMINCPLUSPLUS", pathJoin(root, "logs/Xerces-C++-3.2.4-GCCcore-12.2.0-easybuild-devel"))
