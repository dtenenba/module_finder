...
local root = "/app/software/igraph/0.7.1-foss-2019b"
...
setenv("EBVERSIONIGRAPH", "0.7.1")
setenv("EBDEVELIGRAPH", pathJoin(root, "logs/igraph-0.7.1-foss-2019b-easybuild-devel"))
