...
local root = "/app/software/igraph/0.9.5-foss-2021b"
...
if not ( isloaded("SuiteSparse/5.10.1-foss-2021b-METIS-5.1.0") ) then
    load("SuiteSparse/5.10.1-foss-2021b-METIS-5.1.0")
end

if not ( isloaded("arpack-ng/3.8.0-foss-2021b") ) then
    load("arpack-ng/3.8.0-foss-2021b")
end
...
setenv("EBVERSIONIGRAPH", "0.9.5")
setenv("EBDEVELIGRAPH", pathJoin(root, "logs/igraph-0.9.5-foss-2021b-easybuild-devel"))
