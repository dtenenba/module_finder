...
local root = "/app/software/libtasn1/4.18.0-GCCcore-11.2.0"
...
setenv("EBVERSIONLIBTASN1", "4.18.0")
setenv("EBDEVELLIBTASN1", pathJoin(root, "logs/libtasn1-4.18.0-GCCcore-11.2.0-easybuild-devel"))
