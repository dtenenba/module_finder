...
local root = "/app/software/GStreamer/1.16.2-GCC-8.3.0"
...
setenv("EBVERSIONGSTREAMER", "1.16.2")
setenv("EBDEVELGSTREAMER", pathJoin(root, "logs/GStreamer-1.16.2-GCC-8.3.0-easybuild-devel"))
