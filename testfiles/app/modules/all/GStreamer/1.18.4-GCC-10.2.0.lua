...
local root = "/app/software/GStreamer/1.18.4-GCC-10.2.0"
...
setenv("EBVERSIONGSTREAMER", "1.18.4")
setenv("EBDEVELGSTREAMER", pathJoin(root, "logs/GStreamer-1.18.4-GCC-10.2.0-easybuild-devel"))
