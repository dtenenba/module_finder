...
local root = "/app/software/dask/2021.2.0-fosscuda-2020b"
...
if not ( isloaded("bokeh/2.2.3-fosscuda-2020b") ) then
    load("bokeh/2.2.3-fosscuda-2020b")
end
...
setenv("EBDEVELDASK", pathJoin(root, "logs/dask-2021.2.0-fosscuda-2020b-easybuild-devel"))
