...
local root = "/app/software/libjpeg-turbo/2.0.3-GCCcore-8.3.0"
...
setenv("EBDEVELLIBJPEGMINTURBO", pathJoin(root, "logs/libjpeg-turbo-2.0.3-GCCcore-8.3.0-easybuild-devel"))
