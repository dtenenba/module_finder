...
local root = "/app/software/libjpeg-turbo/2.0.4-GCCcore-9.3.0"
...
if not ( isloaded("NASM/2.14.02-GCCcore-9.3.0") ) then
    load("NASM/2.14.02-GCCcore-9.3.0")
end
...
setenv("EBDEVELLIBJPEGMINTURBO", pathJoin(root, "logs/libjpeg-turbo-2.0.4-GCCcore-9.3.0-easybuild-devel"))
