...
local root = "/app/software/libjpeg-turbo/2.0.5-GCCcore-10.2.0"
...
setenv("EBDEVELLIBJPEGMINTURBO", pathJoin(root, "logs/libjpeg-turbo-2.0.5-GCCcore-10.2.0-easybuild-devel"))
