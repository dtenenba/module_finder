...
local root = "/app/software/libjpeg-turbo/2.0.6-GCCcore-10.3.0"
...
setenv("EBDEVELLIBJPEGMINTURBO", pathJoin(root, "logs/libjpeg-turbo-2.0.6-GCCcore-10.3.0-easybuild-devel"))
