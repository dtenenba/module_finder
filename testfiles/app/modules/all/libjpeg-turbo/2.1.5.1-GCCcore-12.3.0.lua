...
local root = "/app/software/libjpeg-turbo/2.1.5.1-GCCcore-12.3.0"
...
setenv("EBVERSIONLIBJPEGMINTURBO", "2.1.5.1")
setenv("EBDEVELLIBJPEGMINTURBO", pathJoin(root, "logs/libjpeg-turbo-2.1.5.1-GCCcore-12.3.0-easybuild-devel"))
