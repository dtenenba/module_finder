...
local root = "/app/software/libjpeg-turbo/2.0.6-GCCcore-11.2.0"
...
setenv("EBDEVELLIBJPEGMINTURBO", pathJoin(root, "logs/libjpeg-turbo-2.0.6-GCCcore-11.2.0-easybuild-devel"))
