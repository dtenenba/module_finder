...
local root = "/app/software/OpenEXR/3.2.0-GCCcore-13.2.0"
...
if not ( isloaded("Imath/3.1.9-GCCcore-13.2.0") ) then
    load("Imath/3.1.9-GCCcore-13.2.0")
end
...
setenv("EBVERSIONOPENEXR", "3.2.0")
setenv("EBDEVELOPENEXR", pathJoin(root, "logs/OpenEXR-3.2.0-GCCcore-13.2.0-easybuild-devel"))
