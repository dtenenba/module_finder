...
local root = "/app/software/Automake/1.16.1-GCCcore-9.3.0"
...
if not ( isloaded("Autoconf/2.69-GCCcore-9.3.0") ) then
    load("Autoconf/2.69-GCCcore-9.3.0")
end
...
setenv("EBDEVELAUTOMAKE", pathJoin(root, "logs/Automake-1.16.1-GCCcore-9.3.0-easybuild-devel"))
