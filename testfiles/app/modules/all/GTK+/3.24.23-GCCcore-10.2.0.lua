...
local root = "/app/software/GTK+/3.24.23-GCCcore-10.2.0"
...
if not ( isloaded("at-spi2-atk/2.38.0-GCCcore-10.2.0") ) then
    load("at-spi2-atk/2.38.0-GCCcore-10.2.0")
end
...
if not ( isloaded("libepoxy/1.5.4-GCCcore-10.2.0") ) then
    load("libepoxy/1.5.4-GCCcore-10.2.0")
end
...
setenv("EBVERSIONGTKPLUS", "3.24.23")
setenv("EBDEVELGTKPLUS", pathJoin(root, "logs/GTK+-3.24.23-GCCcore-10.2.0-easybuild-devel"))
