...
local root = "/app/software/GDB/10.2-GCCcore-10.3.0"
...
if not ( isloaded("ISL/0.23-GCCcore-10.3.0") ) then
    load("ISL/0.23-GCCcore-10.3.0")
end

if not ( isloaded("MPC/1.2.1-GCCcore-10.3.0") ) then
    load("MPC/1.2.1-GCCcore-10.3.0")
end
...
setenv("EBVERSIONGDB", "10.2")
setenv("EBDEVELGDB", pathJoin(root, "logs/GDB-10.2-GCCcore-10.3.0-easybuild-devel"))
