...
local root = "/app/software/PyTables/3.6.1-foss-2021a"
...
if not ( isloaded("LZO/2.10-GCCcore-10.3.0") ) then
    load("LZO/2.10-GCCcore-10.3.0")
end

if not ( isloaded("Blosc/1.21.0-GCCcore-10.3.0") ) then
    load("Blosc/1.21.0-GCCcore-10.3.0")
end
...
setenv("EBDEVELPYTABLES", pathJoin(root, "logs/PyTables-3.6.1-foss-2021a-easybuild-devel"))
