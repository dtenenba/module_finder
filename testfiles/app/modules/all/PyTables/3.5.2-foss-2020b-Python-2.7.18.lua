...
local root = "/app/software/PyTables/3.5.2-foss-2020b-Python-2.7.18"
...
setenv("EBDEVELPYTABLES", pathJoin(root, "logs/PyTables-3.5.2-foss-2020b-Python-2.7.18-easybuild-devel"))
