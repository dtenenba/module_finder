...
local root = "/app/software/GDRCopy/2.1-GCCcore-10.2.0-CUDA-11.1.1"
...
if not ( isloaded("Check/0.15.2-GCCcore-10.2.0") ) then
    load("Check/0.15.2-GCCcore-10.2.0")
end
...
setenv("EBDEVELGDRCOPY", pathJoin(root, "logs/GDRCopy-2.1-GCCcore-10.2.0-CUDA-11.1.1-easybuild-devel"))
