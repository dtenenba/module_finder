...
local root = "/app/software/GDRCopy/2.3.1-GCCcore-12.3.0"
...
setenv("EBVERSIONGDRCOPY", "2.3.1")
setenv("EBDEVELGDRCOPY", pathJoin(root, "logs/GDRCopy-2.3.1-GCCcore-12.3.0-easybuild-devel"))
