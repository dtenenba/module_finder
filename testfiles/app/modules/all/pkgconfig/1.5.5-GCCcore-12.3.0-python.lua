...
local root = "/app/software/pkgconfig/1.5.5-GCCcore-12.3.0-python"
...
if not ( isloaded("pkgconf/1.9.5-GCCcore-12.3.0") ) then
    load("pkgconf/1.9.5-GCCcore-12.3.0")
end

prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTPKGCONFIG", root)
setenv("EBVERSIONPKGCONFIG", "1.5.5")
setenv("EBDEVELPKGCONFIG", pathJoin(root, "logs/pkgconfig-1.5.5-GCCcore-12.3.0-python-easybuild-devel"))
