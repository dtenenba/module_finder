...
local root = "/app/software/PyYAML/6.0-GCCcore-11.3.0"
...
if not ( isloaded("libyaml/0.2.5-GCCcore-11.3.0") ) then
    load("libyaml/0.2.5-GCCcore-11.3.0")
end

prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTPYYAML", root)
setenv("EBVERSIONPYYAML", "6.0")
setenv("EBDEVELPYYAML", pathJoin(root, "logs/PyYAML-6.0-GCCcore-11.3.0-easybuild-devel"))
