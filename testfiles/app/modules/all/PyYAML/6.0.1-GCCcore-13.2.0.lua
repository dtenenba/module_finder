...
local root = "/app/software/PyYAML/6.0.1-GCCcore-13.2.0"
...
if not ( isloaded("libyaml/0.2.5-GCCcore-13.2.0") ) then
    load("libyaml/0.2.5-GCCcore-13.2.0")
end
...
setenv("EBVERSIONPYYAML", "6.0.1")
setenv("EBDEVELPYYAML", pathJoin(root, "logs/PyYAML-6.0.1-GCCcore-13.2.0-easybuild-devel"))
