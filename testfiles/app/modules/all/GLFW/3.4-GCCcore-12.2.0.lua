...
local root = "/app/software/GLFW/3.4-GCCcore-12.2.0"
...
if not ( isloaded("Wayland/1.22.0-GCCcore-12.2.0") ) then
    load("Wayland/1.22.0-GCCcore-12.2.0")
end
...
setenv("EBVERSIONGLFW", "3.4")
setenv("EBDEVELGLFW", pathJoin(root, "logs/GLFW-3.4-GCCcore-12.2.0-easybuild-devel"))
