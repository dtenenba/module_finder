...
local root = "/app/software/CFITSIO/4.3.1-GCCcore-13.2.0"
...
setenv("EBVERSIONCFITSIO", "4.3.1")
setenv("EBDEVELCFITSIO", pathJoin(root, "logs/CFITSIO-4.3.1-GCCcore-13.2.0-easybuild-devel"))
