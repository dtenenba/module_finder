...
Included extensions
===================
astropy-5.3.4, colorlog-6.8.2, extension-helpers-1.1.1, pyerfa-2.0.1.4
]==])
...
whatis([==[Extensions: astropy-5.3.4, colorlog-6.8.2, extension-helpers-1.1.1, pyerfa-2.0.1.4]==])

local root = "/app/software/astropy/5.3.4-gfbf-2023a"
...
setenv("EBDEVELASTROPY", pathJoin(root, "logs/astropy-5.3.4-gfbf-2023a-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.11/site-packages"))
-- Built with EasyBuild version 4.9.1
setenv("EBEXTSLISTASTROPY", "colorlog-6.8.2,pyerfa-2.0.1.4,extension-helpers-1.1.1,astropy-5.3.4")
