...
local root = "/app/software/BAli-Phy/4.0-beta8-gfbf-2022b"
...
if not ( isloaded("gnuplot/5.4.6-GCCcore-12.2.0") ) then
    load("gnuplot/5.4.6-GCCcore-12.2.0")
end
...
setenv("EBDEVELBALIMINPHY", pathJoin(root, "logs/BAli-Phy-4.0-beta8-gfbf-2022b-easybuild-devel"))
