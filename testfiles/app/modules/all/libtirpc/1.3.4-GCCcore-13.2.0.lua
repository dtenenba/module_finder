...
local root = "/app/software/libtirpc/1.3.4-GCCcore-13.2.0"
...
setenv("EBVERSIONLIBTIRPC", "1.3.4")
setenv("EBDEVELLIBTIRPC", pathJoin(root, "logs/libtirpc-1.3.4-GCCcore-13.2.0-easybuild-devel"))
