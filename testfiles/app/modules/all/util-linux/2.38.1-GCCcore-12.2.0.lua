...
local root = "/app/software/util-linux/2.38.1-GCCcore-12.2.0"
...
setenv("EBDEVELUTILMINLINUX", pathJoin(root, "logs/util-linux-2.38.1-GCCcore-12.2.0-easybuild-devel"))
