...
local root = "/app/software/util-linux/2.38-GCCcore-11.3.0"
...
setenv("EBVERSIONUTILMINLINUX", "2.38")
setenv("EBDEVELUTILMINLINUX", pathJoin(root, "logs/util-linux-2.38-GCCcore-11.3.0-easybuild-devel"))
