...
local root = "/app/software/hypothesis/6.82.0-GCCcore-12.3.0"
...
setenv("EBVERSIONHYPOTHESIS", "6.82.0")
setenv("EBDEVELHYPOTHESIS", pathJoin(root, "logs/hypothesis-6.82.0-GCCcore-12.3.0-easybuild-devel"))
