...
local root = "/app/software/hypothesis/6.7.0-GCCcore-10.2.0"
...
setenv("EBVERSIONHYPOTHESIS", "6.7.0")
setenv("EBDEVELHYPOTHESIS", pathJoin(root, "logs/hypothesis-6.7.0-GCCcore-10.2.0-easybuild-devel"))
