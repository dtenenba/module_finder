...
local root = "/app/software/nsync/1.25.0-GCCcore-11.3.0"
...
setenv("EBVERSIONNSYNC", "1.25.0")
setenv("EBDEVELNSYNC", pathJoin(root, "logs/nsync-1.25.0-GCCcore-11.3.0-easybuild-devel"))
