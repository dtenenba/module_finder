...
local root = "/app/software/nsync/1.26.0-GCCcore-12.3.0"
...
setenv("EBVERSIONNSYNC", "1.26.0")
setenv("EBDEVELNSYNC", pathJoin(root, "logs/nsync-1.26.0-GCCcore-12.3.0-easybuild-devel"))
