...
local root = "/app/software/Lua/5.4.3-GCCcore-11.2.0"
...
setenv("EBDEVELLUA", pathJoin(root, "logs/Lua-5.4.3-GCCcore-11.2.0-easybuild-devel"))

setenv("LUA_DIR", "/app/software/Lua/5.4.3-GCCcore-11.2.0")
