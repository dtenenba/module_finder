...
local root = "/app/software/Gurobi/9.1.2"
...
setenv("EBVERSIONGUROBI", "9.1.2")
setenv("EBDEVELGUROBI", pathJoin(root, "logs/Gurobi-9.1.2-easybuild-devel"))

setenv("GUROBI_HOME", "/app/software/Gurobi/9.1.2")
setenv("GRB_LICENSE_FILE", "/app/software/Gurobi/9.1.2/gurobi.lic")
prepend_path("PATH", pathJoin(root, "bin"))
prepend_path("LD_LIBRARY_PATH", pathJoin(root, "lib"))
