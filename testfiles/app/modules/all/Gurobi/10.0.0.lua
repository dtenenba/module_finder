...
local root = "/app/software/Gurobi/10.0.0"
...
setenv("EBVERSIONGUROBI", "10.0.0")
setenv("EBDEVELGUROBI", pathJoin(root, "logs/Gurobi-10.0.0-easybuild-devel"))

setenv("GUROBI_HOME", "/app/software/Gurobi/10.0.0")
