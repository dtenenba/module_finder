...
local root = "/app/software/Gurobi/gurobi952/linux64"
...
setenv("EBVERSIONGUROBI", "9.5.2")

setenv("GUROBI_HOME", root)
setenv("GRB_LICENSE_FILE", pathJoin(root, "gurobi.lic"))
prepend_path("PATH", pathJoin(root, "bin"))
prepend_path("LD_LIBRARY_PATH", pathJoin(root, "lib"))
-- hand-built - with vim by John Dey 2022.08.31 
