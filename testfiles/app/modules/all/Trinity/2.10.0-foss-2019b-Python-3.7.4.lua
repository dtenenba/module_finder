...
local root = "/app/software/Trinity/2.10.0-foss-2019b-Python-3.7.4"
...
setenv("EBDEVELTRINITY", pathJoin(root, "logs/Trinity-2.10.0-foss-2019b-Python-3.7.4-easybuild-devel"))
