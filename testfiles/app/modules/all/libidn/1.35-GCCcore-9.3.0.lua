...
local root = "/app/software/libidn/1.35-GCCcore-9.3.0"
...
setenv("EBVERSIONLIBIDN", "1.35")
setenv("EBDEVELLIBIDN", pathJoin(root, "logs/libidn-1.35-GCCcore-9.3.0-easybuild-devel"))
