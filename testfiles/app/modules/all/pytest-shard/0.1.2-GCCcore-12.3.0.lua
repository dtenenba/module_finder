...
local root = "/app/software/pytest-shard/0.1.2-GCCcore-12.3.0"
...
setenv("EBDEVELPYTESTMINSHARD", pathJoin(root, "logs/pytest-shard-0.1.2-GCCcore-12.3.0-easybuild-devel"))
