...
local root = "/app/software/Emacs/26.3-GCCcore-8.3.0-ESS"
...
if not ( isloaded("ESS/18.10.2") ) then
    load("ESS/18.10.2")
end
...
setenv("EBDEVELEMACS", pathJoin(root, "logs/Emacs-26.3-GCCcore-8.3.0-ESS-easybuild-devel"))
