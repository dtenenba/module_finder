...
local root = "/app/software/rMATS-turbo/4.1.1-foss-2020b"
...
setenv("EBVERSIONRMATSMINTURBO", "4.1.1")
setenv("EBDEVELRMATSMINTURBO", pathJoin(root, "logs/rMATS-turbo-4.1.1-foss-2020b-easybuild-devel"))
