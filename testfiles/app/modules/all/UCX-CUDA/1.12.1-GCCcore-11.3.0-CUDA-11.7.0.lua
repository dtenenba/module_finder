...
local root = "/app/software/UCX-CUDA/1.12.1-GCCcore-11.3.0-CUDA-11.7.0"
...
if not ( isloaded("GDRCopy/2.3-GCCcore-11.3.0") ) then
    load("GDRCopy/2.3-GCCcore-11.3.0")
end

prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTUCXMINCUDA", root)
setenv("EBVERSIONUCXMINCUDA", "1.12.1")
setenv("EBDEVELUCXMINCUDA", pathJoin(root, "logs/UCX-CUDA-1.12.1-GCCcore-11.3.0-CUDA-11.7.0-easybuild-devel"))
