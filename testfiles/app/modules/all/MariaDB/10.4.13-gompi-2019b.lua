...
local root = "/app/software/MariaDB/10.4.13-gompi-2019b"
...
setenv("EBVERSIONMARIADB", "10.4.13")
setenv("EBDEVELMARIADB", pathJoin(root, "logs/MariaDB-10.4.13-gompi-2019b-easybuild-devel"))
