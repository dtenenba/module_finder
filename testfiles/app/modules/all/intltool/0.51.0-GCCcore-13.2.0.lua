...
local root = "/app/software/intltool/0.51.0-GCCcore-13.2.0"
...
if not ( isloaded("Perl-bundle-CPAN/5.38.0-GCCcore-13.2.0") ) then
    load("Perl-bundle-CPAN/5.38.0-GCCcore-13.2.0")
end
...
setenv("EBDEVELINTLTOOL", pathJoin(root, "logs/intltool-0.51.0-GCCcore-13.2.0-easybuild-devel"))
