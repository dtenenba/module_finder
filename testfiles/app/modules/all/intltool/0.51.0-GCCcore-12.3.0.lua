...
local root = "/app/software/intltool/0.51.0-GCCcore-12.3.0"
...
if not ( isloaded("Perl-bundle-CPAN/5.36.1-GCCcore-12.3.0") ) then
    load("Perl-bundle-CPAN/5.36.1-GCCcore-12.3.0")
end
...
setenv("EBDEVELINTLTOOL", pathJoin(root, "logs/intltool-0.51.0-GCCcore-12.3.0-easybuild-devel"))
