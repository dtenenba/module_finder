...
local root = "/app/software/protobuf/3.19.4-GCCcore-11.3.0"
...
setenv("EBVERSIONPROTOBUF", "3.19.4")
setenv("EBDEVELPROTOBUF", pathJoin(root, "logs/protobuf-3.19.4-GCCcore-11.3.0-easybuild-devel"))
