...
local root = "/app/software/protobuf/22.4-GCCcore-12.2.0"
...
setenv("EBVERSIONPROTOBUF", "22.4")
setenv("EBDEVELPROTOBUF", pathJoin(root, "logs/protobuf-22.4-GCCcore-12.2.0-easybuild-devel"))
