...
local root = "/app/software/GLib/2.66.1-GCCcore-10.2.0"
...
if not ( isloaded("gettext/0.21-GCCcore-10.2.0") ) then
    load("gettext/0.21-GCCcore-10.2.0")
end
...
setenv("EBDEVELGLIB", pathJoin(root, "logs/GLib-2.66.1-GCCcore-10.2.0-easybuild-devel"))
