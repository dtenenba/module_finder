...
local root = "/app/software/GLib/2.64.1-GCCcore-9.3.0"
...
if not ( isloaded("gettext/0.20.1-GCCcore-9.3.0") ) then
    load("gettext/0.20.1-GCCcore-9.3.0")
end
...
setenv("EBDEVELGLIB", pathJoin(root, "logs/GLib-2.64.1-GCCcore-9.3.0-easybuild-devel"))
