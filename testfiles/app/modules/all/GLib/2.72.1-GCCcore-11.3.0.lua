...
local root = "/app/software/GLib/2.72.1-GCCcore-11.3.0"
...
if not ( isloaded("PCRE/8.45-GCCcore-11.3.0") ) then
    load("PCRE/8.45-GCCcore-11.3.0")
end
...
setenv("EBVERSIONGLIB", "2.72.1")
setenv("EBDEVELGLIB", pathJoin(root, "logs/GLib-2.72.1-GCCcore-11.3.0-easybuild-devel"))
