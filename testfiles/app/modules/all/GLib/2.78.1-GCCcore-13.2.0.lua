...
local root = "/app/software/GLib/2.78.1-GCCcore-13.2.0"
...
setenv("EBVERSIONGLIB", "2.78.1")
setenv("EBDEVELGLIB", pathJoin(root, "logs/GLib-2.78.1-GCCcore-13.2.0-easybuild-devel"))
