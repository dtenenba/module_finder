...
local root = "/app/software/PyCairo/1.20.1-GCCcore-10.3.0"
...
if not ( isloaded("cairo/1.16.0-GCCcore-10.3.0") ) then
    load("cairo/1.16.0-GCCcore-10.3.0")
end
...
setenv("EBDEVELPYCAIRO", pathJoin(root, "logs/PyCairo-1.20.1-GCCcore-10.3.0-easybuild-devel"))
