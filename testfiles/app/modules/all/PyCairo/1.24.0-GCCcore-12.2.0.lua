...
local root = "/app/software/PyCairo/1.24.0-GCCcore-12.2.0"
...
setenv("EBVERSIONPYCAIRO", "1.24.0")
setenv("EBDEVELPYCAIRO", pathJoin(root, "logs/PyCairo-1.24.0-GCCcore-12.2.0-easybuild-devel"))
