...
local root = "/app/software/fontconfig/2.14.0-GCCcore-11.3.0"
...
setenv("EBVERSIONFONTCONFIG", "2.14.0")
setenv("EBDEVELFONTCONFIG", pathJoin(root, "logs/fontconfig-2.14.0-GCCcore-11.3.0-easybuild-devel"))
