...
local root = "/app/software/SuiteSparse/5.8.1-foss-2020b-METIS-5.1.0"
...
setenv("EBVERSIONSUITESPARSE", "5.8.1")
setenv("EBDEVELSUITESPARSE", pathJoin(root, "logs/SuiteSparse-5.8.1-foss-2020b-METIS-5.1.0-easybuild-devel"))
