...
local root = "/app/software/SuiteSparse/5.10.1-foss-2021a-METIS-5.1.0"
...
setenv("EBDEVELSUITESPARSE", pathJoin(root, "logs/SuiteSparse-5.10.1-foss-2021a-METIS-5.1.0-easybuild-devel"))
