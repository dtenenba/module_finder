...
local root = "/app/software/Clp/1.17.6-GCCcore-10.2.0"
...
if not ( isloaded("CoinUtils/2.11.4-GCCcore-10.2.0") ) then
    load("CoinUtils/2.11.4-GCCcore-10.2.0")
end

if not ( isloaded("Osi/0.108.6-GCCcore-10.2.0") ) then
    load("Osi/0.108.6-GCCcore-10.2.0")
end
...
setenv("EBDEVELCLP", pathJoin(root, "logs/Clp-1.17.6-GCCcore-10.2.0-easybuild-devel"))
