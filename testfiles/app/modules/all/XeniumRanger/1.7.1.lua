...
local root = "/app/software/XeniumRanger/1.7.1"
...
setenv("EBVERSIONXENIUMRANGER", "1.7.1")
setenv("EBDEVELXENIUMRANGER", pathJoin(root, "logs/XeniumRanger-1.7.1-easybuild-devel"))
...
io.stderr:write([==[
    ...
    Alternatively '--jobmode=<templatefile>' can be used with the path to a custom template file if needed:
        ...
        To create a custom template, copy '/app/software/XeniumRanger/1.7.1/external/martian/jobmanagers/slurm.template' to a location of your choice and edit as necessary.
