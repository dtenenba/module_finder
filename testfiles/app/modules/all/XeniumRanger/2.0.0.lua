...
local root = "/app/software/XeniumRanger/2.0.0"
...
setenv("EBVERSIONXENIUMRANGER", "2.0.0")
setenv("EBDEVELXENIUMRANGER", pathJoin(root, "logs/XeniumRanger-2.0.0-easybuild-devel"))
...
io.stderr:write([==[
    ...
    Alternatively '--jobmode=<templatefile>' can be used with the path to a custom template file if needed:
        ...
        To create a custom template, copy '/app/software/XeniumRanger/2.0.0/external/martian/jobmanagers/slurm.template' to a location of your choice and edit as necessary.
