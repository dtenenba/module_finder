...
local root = "/app/software/SpectrA/0.9.0-GCC-10.2.0"
...
if not ( isloaded("Eigen/3.3.9-GCCcore-10.2.0") ) then
    load("Eigen/3.3.9-GCCcore-10.2.0")
end

prepend_path("CMAKE_PREFIX_PATH", root)
prepend_path("CPATH", pathJoin(root, "include"))
setenv("EBROOTSPECTRA", root)
setenv("EBVERSIONSPECTRA", "0.9.0")
setenv("EBDEVELSPECTRA", pathJoin(root, "logs/SpectrA-0.9.0-GCC-10.2.0-easybuild-devel"))
