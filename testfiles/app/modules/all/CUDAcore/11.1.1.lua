...
local root = "/app/software/CUDAcore/11.1.1"
...
setenv("EBDEVELCUDACORE", pathJoin(root, "logs/CUDAcore-11.1.1-easybuild-devel"))

prepend_path("PATH", root)
setenv("CUDA_HOME", "/app/software/CUDAcore/11.1.1")
setenv("CUDA_ROOT", "/app/software/CUDAcore/11.1.1")
setenv("CUDA_PATH", "/app/software/CUDAcore/11.1.1")
