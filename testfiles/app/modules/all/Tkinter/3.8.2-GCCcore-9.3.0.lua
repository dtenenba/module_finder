...
local root = "/app/software/Tkinter/3.8.2-GCCcore-9.3.0"
...
if not ( isloaded("Tk/8.6.10-GCCcore-9.3.0") ) then
    load("Tk/8.6.10-GCCcore-9.3.0")
end
...
setenv("EBVERSIONTKINTER", "3.8.2")
setenv("EBDEVELTKINTER", pathJoin(root, "logs/Tkinter-3.8.2-GCCcore-9.3.0-easybuild-devel"))
