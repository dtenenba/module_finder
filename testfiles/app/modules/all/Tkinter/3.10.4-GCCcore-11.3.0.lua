...
local root = "/app/software/Tkinter/3.10.4-GCCcore-11.3.0"
...
if not ( isloaded("Tk/8.6.12-GCCcore-11.3.0") ) then
    load("Tk/8.6.12-GCCcore-11.3.0")
end
...
setenv("EBVERSIONTKINTER", "3.10.4")
setenv("EBDEVELTKINTER", pathJoin(root, "logs/Tkinter-3.10.4-GCCcore-11.3.0-easybuild-devel"))
