...
local root = "/app/software/Tkinter/2.7.16-GCCcore-8.3.0"
...
setenv("EBVERSIONTKINTER", "2.7.16")
setenv("EBDEVELTKINTER", pathJoin(root, "logs/Tkinter-2.7.16-GCCcore-8.3.0-easybuild-devel"))
