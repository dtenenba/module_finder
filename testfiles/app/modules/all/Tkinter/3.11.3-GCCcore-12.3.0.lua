...
local root = "/app/software/Tkinter/3.11.3-GCCcore-12.3.0"
...
setenv("EBVERSIONTKINTER", "3.11.3")
setenv("EBDEVELTKINTER", pathJoin(root, "logs/Tkinter-3.11.3-GCCcore-12.3.0-easybuild-devel"))
