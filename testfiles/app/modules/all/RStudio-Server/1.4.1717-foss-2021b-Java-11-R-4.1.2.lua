...
local root = "/app/software/RStudio-Server/1.4.1717-foss-2021b-Java-11-R-4.1.2"
...
setenv("EBDEVELRSTUDIOMINSERVER", pathJoin(root, "logs/RStudio-Server-1.4.1717-foss-2021b-Java-11-R-4.1.2-easybuild-devel"))
