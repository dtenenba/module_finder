...
local root = "/app/software/RStudio-Server/2022.07.2+576-foss-2022b-Java-11-R-4.3.1"
...
if not ( isloaded("SOCI/4.0.3-GCC-12.2.0") ) then
    load("SOCI/4.0.3-GCC-12.2.0")
end
...
setenv("EBVERSIONRSTUDIOMINSERVER", "2022.07.2+576")
setenv("EBDEVELRSTUDIOMINSERVER", pathJoin(root, "logs/RStudio-Server-2022.07.2+576-foss-2022b-Java-11-R-4.3.1-easybuild-devel"))
