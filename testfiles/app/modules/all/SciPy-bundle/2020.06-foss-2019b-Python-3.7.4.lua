...
local root = "/app/software/SciPy-bundle/2020.06-foss-2019b-Python-3.7.4"
...
setenv("EBDEVELSCIPYMINBUNDLE", pathJoin(root, "logs/SciPy-bundle-2020.06-foss-2019b-Python-3.7.4-easybuild-devel"))
