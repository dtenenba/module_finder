...
Included extensions
===================
beniget-0.4.1, Bottleneck-1.3.4, deap-1.3.1, gast-0.5.3, mpi4py-3.1.3,
...
whatis([==[Extensions: beniget-0.4.1, Bottleneck-1.3.4, deap-1.3.1, gast-0.5.3, mpi4py-3.1.3, mpmath-1.2.1, numexpr-2.8.1, numpy-1.22.3, pandas-1.4.2, ply-3.11, pythran-0.11.0, scipy-1.8.1]==])

local root = "/app/software/SciPy-bundle/2022.05-foss-2021b"
...
setenv("EBDEVELSCIPYMINBUNDLE", pathJoin(root, "logs/SciPy-bundle-2022.05-foss-2021b-easybuild-devel"))
