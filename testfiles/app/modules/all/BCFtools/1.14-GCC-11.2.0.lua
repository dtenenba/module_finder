...
local root = "/app/software/BCFtools/1.14-GCC-11.2.0"
...
setenv("EBVERSIONBCFTOOLS", "1.14")
setenv("EBDEVELBCFTOOLS", pathJoin(root, "logs/BCFtools-1.14-GCC-11.2.0-easybuild-devel"))
