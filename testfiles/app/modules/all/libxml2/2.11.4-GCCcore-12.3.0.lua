...
local root = "/app/software/libxml2/2.11.4-GCCcore-12.3.0"
...
setenv("EBVERSIONLIBXML2", "2.11.4")
setenv("EBDEVELLIBXML2", pathJoin(root, "logs/libxml2-2.11.4-GCCcore-12.3.0-easybuild-devel"))
