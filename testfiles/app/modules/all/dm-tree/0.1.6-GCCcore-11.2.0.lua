...
local root = "/app/software/dm-tree/0.1.6-GCCcore-11.2.0"
...
setenv("EBVERSIONDMMINTREE", "0.1.6")
setenv("EBDEVELDMMINTREE", pathJoin(root, "logs/dm-tree-0.1.6-GCCcore-11.2.0-easybuild-devel"))
