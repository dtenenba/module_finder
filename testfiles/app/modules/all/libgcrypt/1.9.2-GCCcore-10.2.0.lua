...
local root = "/app/software/libgcrypt/1.9.2-GCCcore-10.2.0"
...
if not ( isloaded("libgpg-error/1.41-GCCcore-10.2.0") ) then
    load("libgpg-error/1.41-GCCcore-10.2.0")
end
...
setenv("EBVERSIONLIBGCRYPT", "1.9.2")
setenv("EBDEVELLIBGCRYPT", pathJoin(root, "logs/libgcrypt-1.9.2-GCCcore-10.2.0-easybuild-devel"))
