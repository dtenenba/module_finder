...
local root = "/app/software/Arrow/11.0.0-gfbf-2022b"
...
if not ( isloaded("RapidJSON/1.1.0-GCCcore-12.2.0") ) then
    load("RapidJSON/1.1.0-GCCcore-12.2.0")
end
...
if not ( isloaded("utf8proc/2.8.0-GCCcore-12.2.0") ) then
    load("utf8proc/2.8.0-GCCcore-12.2.0")
end
...
setenv("EBDEVELARROW", pathJoin(root, "logs/Arrow-11.0.0-gfbf-2022b-easybuild-devel"))
