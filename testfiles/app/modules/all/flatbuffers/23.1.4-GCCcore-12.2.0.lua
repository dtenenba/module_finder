...
local root = "/app/software/flatbuffers/23.1.4-GCCcore-12.2.0"
...
setenv("EBVERSIONFLATBUFFERS", "23.1.4")
setenv("EBDEVELFLATBUFFERS", pathJoin(root, "logs/flatbuffers-23.1.4-GCCcore-12.2.0-easybuild-devel"))
