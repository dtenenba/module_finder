...
local root = "/app/software/nodejs/20.9.0-GCCcore-13.2.0"
...
setenv("EBVERSIONNODEJS", "20.9.0")
setenv("EBDEVELNODEJS", pathJoin(root, "logs/nodejs-20.9.0-GCCcore-13.2.0-easybuild-devel"))
