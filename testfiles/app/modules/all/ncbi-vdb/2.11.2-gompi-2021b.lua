...
local root = "/app/software/ncbi-vdb/2.11.2-gompi-2021b"
...
setenv("EBVERSIONNCBIMINVDB", "2.11.2")
setenv("EBDEVELNCBIMINVDB", pathJoin(root, "logs/ncbi-vdb-2.11.2-gompi-2021b-easybuild-devel"))
