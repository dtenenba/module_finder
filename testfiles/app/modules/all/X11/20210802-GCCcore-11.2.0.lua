...
local root = "/app/software/X11/20210802-GCCcore-11.2.0"
...
if not ( isloaded("xorg-macros/1.19.3-GCCcore-11.2.0") ) then
    load("xorg-macros/1.19.3-GCCcore-11.2.0")
end

if not ( isloaded("libpciaccess/0.16-GCCcore-11.2.0") ) then
    load("libpciaccess/0.16-GCCcore-11.2.0")
end
...
setenv("EBDEVELX11", pathJoin(root, "logs/X11-20210802-GCCcore-11.2.0-easybuild-devel"))
