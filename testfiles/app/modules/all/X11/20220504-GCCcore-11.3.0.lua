...
local root = "/app/software/X11/20220504-GCCcore-11.3.0"
...
if not ( isloaded("fontconfig/2.14.0-GCCcore-11.3.0") ) then
    load("fontconfig/2.14.0-GCCcore-11.3.0")
end
...
if not ( isloaded("xorg-macros/1.19.3-GCCcore-11.3.0") ) then
    load("xorg-macros/1.19.3-GCCcore-11.3.0")
end

if not ( isloaded("libpciaccess/0.16-GCCcore-11.3.0") ) then
    load("libpciaccess/0.16-GCCcore-11.3.0")
end
...
setenv("EBVERSIONX11", "20220504")
setenv("EBDEVELX11", pathJoin(root, "logs/X11-20220504-GCCcore-11.3.0-easybuild-devel"))
