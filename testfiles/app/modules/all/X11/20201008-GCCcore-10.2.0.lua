...
local root = "/app/software/X11/20201008-GCCcore-10.2.0"
...
if not ( isloaded("xorg-macros/1.19.2-GCCcore-10.2.0") ) then
    load("xorg-macros/1.19.2-GCCcore-10.2.0")
end
...
setenv("EBDEVELX11", pathJoin(root, "logs/X11-20201008-GCCcore-10.2.0-easybuild-devel"))
