...
local root = "/app/software/X11/20200222-GCCcore-9.3.0"
...
if not ( isloaded("fontconfig/2.13.92-GCCcore-9.3.0") ) then
    load("fontconfig/2.13.92-GCCcore-9.3.0")
end
...
if not ( isloaded("xorg-macros/1.19.2-GCCcore-9.3.0") ) then
    load("xorg-macros/1.19.2-GCCcore-9.3.0")
end

if not ( isloaded("libpciaccess/0.16-GCCcore-9.3.0") ) then
    load("libpciaccess/0.16-GCCcore-9.3.0")
end
...
setenv("EBDEVELX11", pathJoin(root, "logs/X11-20200222-GCCcore-9.3.0-easybuild-devel"))
