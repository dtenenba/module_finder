...
local root = "/app/software/X11/20231019-GCCcore-13.2.0"
...
if not ( isloaded("xorg-macros/1.20.0-GCCcore-13.2.0") ) then
    load("xorg-macros/1.20.0-GCCcore-13.2.0")
end
...
setenv("EBVERSIONX11", "20231019")
setenv("EBDEVELX11", pathJoin(root, "logs/X11-20231019-GCCcore-13.2.0-easybuild-devel"))
