...
local root = "/app/software/Highway/1.0.7-GCCcore-13.2.0"
...
setenv("EBVERSIONHIGHWAY", "1.0.7")
setenv("EBDEVELHIGHWAY", pathJoin(root, "logs/Highway-1.0.7-GCCcore-13.2.0-easybuild-devel"))
