...
local root = "/app/software/x264/20220620-GCCcore-11.3.0"
...
setenv("EBVERSIONX264", "20220620")
setenv("EBDEVELX264", pathJoin(root, "logs/x264-20220620-GCCcore-11.3.0-easybuild-devel"))
