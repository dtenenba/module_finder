...
local root = "/app/software/x264/20190925-GCCcore-8.3.0"
...
setenv("EBVERSIONX264", "20190925")
setenv("EBDEVELX264", pathJoin(root, "logs/x264-20190925-GCCcore-8.3.0-easybuild-devel"))
