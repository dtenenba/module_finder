...
local root = "/app/software/x264/20210414-GCCcore-10.3.0"
...
setenv("EBVERSIONX264", "20210414")
setenv("EBDEVELX264", pathJoin(root, "logs/x264-20210414-GCCcore-10.3.0-easybuild-devel"))
