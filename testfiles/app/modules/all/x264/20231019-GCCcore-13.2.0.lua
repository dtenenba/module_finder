...
local root = "/app/software/x264/20231019-GCCcore-13.2.0"
...
setenv("EBVERSIONX264", "20231019")
setenv("EBDEVELX264", pathJoin(root, "logs/x264-20231019-GCCcore-13.2.0-easybuild-devel"))
