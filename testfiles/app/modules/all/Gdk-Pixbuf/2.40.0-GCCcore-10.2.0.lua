...
local root = "/app/software/Gdk-Pixbuf/2.40.0-GCCcore-10.2.0"
...
setenv("EBVERSIONGDKMINPIXBUF", "2.40.0")
setenv("EBDEVELGDKMINPIXBUF", pathJoin(root, "logs/Gdk-Pixbuf-2.40.0-GCCcore-10.2.0-easybuild-devel"))
