...
local root = "/app/software/Gdk-Pixbuf/2.42.10-GCCcore-12.3.0"
...
setenv("EBDEVELGDKMINPIXBUF", pathJoin(root, "logs/Gdk-Pixbuf-2.42.10-GCCcore-12.3.0-easybuild-devel"))
