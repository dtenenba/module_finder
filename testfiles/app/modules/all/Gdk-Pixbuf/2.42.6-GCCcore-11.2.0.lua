...
local root = "/app/software/Gdk-Pixbuf/2.42.6-GCCcore-11.2.0"
...
setenv("EBVERSIONGDKMINPIXBUF", "2.42.6")
setenv("EBDEVELGDKMINPIXBUF", pathJoin(root, "logs/Gdk-Pixbuf-2.42.6-GCCcore-11.2.0-easybuild-devel"))
