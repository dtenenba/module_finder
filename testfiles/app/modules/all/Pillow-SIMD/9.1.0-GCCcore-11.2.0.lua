...
local root = "/app/software/Pillow-SIMD/9.1.0-GCCcore-11.2.0"
...
setenv("EBVERSIONPILLOWMINSIMD", "9.1.0")
setenv("EBDEVELPILLOWMINSIMD", pathJoin(root, "logs/Pillow-SIMD-9.1.0-GCCcore-11.2.0-easybuild-devel"))
