...
local root = "/app/software/dorado/0.3.4-foss-2022a-CUDA-11.7.0"
...
setenv("EBVERSIONDORADO", "0.3.4")
setenv("EBDEVELDORADO", pathJoin(root, "logs/dorado-0.3.4-foss-2022a-CUDA-11.7.0-easybuild-devel"))
