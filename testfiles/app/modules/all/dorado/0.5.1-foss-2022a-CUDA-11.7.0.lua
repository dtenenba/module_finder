...
local root = "/app/software/dorado/0.5.1-foss-2022a-CUDA-11.7.0"
...
setenv("EBVERSIONDORADO", "0.5.1")
setenv("EBDEVELDORADO", pathJoin(root, "logs/dorado-0.5.1-foss-2022a-CUDA-11.7.0-easybuild-devel"))
