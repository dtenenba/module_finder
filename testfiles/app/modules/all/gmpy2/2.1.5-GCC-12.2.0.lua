...
local root = "/app/software/gmpy2/2.1.5-GCC-12.2.0"
...
if not ( isloaded("MPC/1.3.1-GCCcore-12.2.0") ) then
    load("MPC/1.3.1-GCCcore-12.2.0")
end

prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTGMPY2", root)
setenv("EBVERSIONGMPY2", "2.1.5")
setenv("EBDEVELGMPY2", pathJoin(root, "logs/gmpy2-2.1.5-GCC-12.2.0-easybuild-devel"))
