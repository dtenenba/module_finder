...
local root = "/app/software/scikit-learn/0.21.3-foss-2019b-Python-3.7.4"
...
setenv("EBVERSIONSCIKITMINLEARN", "0.21.3")
setenv("EBDEVELSCIKITMINLEARN", pathJoin(root, "logs/scikit-learn-0.21.3-foss-2019b-Python-3.7.4-easybuild-devel"))
