...
local root = "/app/software/scikit-learn/0.23.2-fosscuda-2020b"
...
setenv("EBVERSIONSCIKITMINLEARN", "0.23.2")
setenv("EBDEVELSCIKITMINLEARN", pathJoin(root, "logs/scikit-learn-0.23.2-fosscuda-2020b-easybuild-devel"))
