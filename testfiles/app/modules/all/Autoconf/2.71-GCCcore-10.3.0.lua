...
local root = "/app/software/Autoconf/2.71-GCCcore-10.3.0"
...
if not ( isloaded("M4/1.4.18-GCCcore-10.3.0") ) then
    load("M4/1.4.18-GCCcore-10.3.0")
end
...
setenv("EBDEVELAUTOCONF", pathJoin(root, "logs/Autoconf-2.71-GCCcore-10.3.0-easybuild-devel"))
