...
local root = "/app/software/Autoconf/2.71-GCCcore-11.2.0"
...
if not ( isloaded("M4/1.4.19-GCCcore-11.2.0") ) then
    load("M4/1.4.19-GCCcore-11.2.0")
end
...
setenv("EBDEVELAUTOCONF", pathJoin(root, "logs/Autoconf-2.71-GCCcore-11.2.0-easybuild-devel"))
