...
local root = "/app/software/Java/1.8.0_162"
...
setenv("EBDEVELJAVA", pathJoin(root, "/app/logs/Java-1.8.0_162-easybuild-devel"))

prepend_path("PATH", root)
setenv("JAVA_HOME", "/app/software/Java/1.8.0_162")
