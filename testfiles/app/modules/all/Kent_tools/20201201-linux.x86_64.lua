...
local root = "/app/software/Kent_tools/20201201-linux.x86_64"
...
setenv("EBVERSIONKENT_TOOLS", "20201201")
setenv("EBDEVELKENT_TOOLS", pathJoin(root, "logs/Kent_tools-20201201-linux.x86_64-easybuild-devel"))
