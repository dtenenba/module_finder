...
local root = "/app/software/libdrm/2.4.115-GCCcore-12.3.0"
...
setenv("EBVERSIONLIBDRM", "2.4.115")
setenv("EBDEVELLIBDRM", pathJoin(root, "logs/libdrm-2.4.115-GCCcore-12.3.0-easybuild-devel"))
