...
local root = "/app/software/Anaconda3/2021.05"
...
setenv("EBVERSIONANACONDA3", "2021.05")
setenv("EBDEVELANACONDA3", pathJoin(root, "logs/Anaconda3-2021.05-easybuild-devel"))
