...
local root = "/app/software/Anaconda3/2020.02"
...
setenv("EBVERSIONANACONDA3", "2020.02")
setenv("EBDEVELANACONDA3", pathJoin(root, "logs/Anaconda3-2020.02-easybuild-devel"))
