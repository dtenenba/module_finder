...
local root = "/app/software/wget/1.21.2-GCCcore-11.2.0"
...
setenv("EBVERSIONWGET", "1.21.2")
setenv("EBDEVELWGET", pathJoin(root, "logs/wget-1.21.2-GCCcore-11.2.0-easybuild-devel"))
