...
local root = "/app/software/minimap2/2.24-GCCcore-11.2.0"
...
setenv("EBVERSIONMINIMAP2", "2.24")
setenv("EBDEVELMINIMAP2", pathJoin(root, "logs/minimap2-2.24-GCCcore-11.2.0-easybuild-devel"))
