...
local root = "/app/software/minimap2/2.26-GCCcore-12.2.0"
...
setenv("EBVERSIONMINIMAP2", "2.26")
setenv("EBDEVELMINIMAP2", pathJoin(root, "logs/minimap2-2.26-GCCcore-12.2.0-easybuild-devel"))
