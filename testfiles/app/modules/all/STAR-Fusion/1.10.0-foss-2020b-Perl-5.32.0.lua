...
local root = "/app/software/STAR-Fusion/1.10.0-foss-2020b-Perl-5.32.0"
...
setenv("EBVERSIONSTARMINFUSION", "1.10.0")
setenv("EBDEVELSTARMINFUSION", pathJoin(root, "logs/STAR-Fusion-1.10.0-foss-2020b-Perl-5.32.0-easybuild-devel"))
