...
local root = "/app/software/philosopher/3.3.10"
...
setenv("EBVERSIONPHILOSOPHER", "3.3.10")
setenv("EBDEVELPHILOSOPHER", pathJoin(root, "logs/philosopher-3.3.10-easybuild-devel"))
