...
local root = "/app/software/philosopher/3.2.9"
...
setenv("EBVERSIONPHILOSOPHER", "3.2.9")
setenv("EBDEVELPHILOSOPHER", pathJoin(root, "logs/philosopher-3.2.9-easybuild-devel"))
