...
local root = "/app/software/philosopher/3.3.11"
...
setenv("EBVERSIONPHILOSOPHER", "3.3.11")
setenv("EBDEVELPHILOSOPHER", pathJoin(root, "logs/philosopher-3.3.11-easybuild-devel"))
