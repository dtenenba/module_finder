...
local root = "/app/software/wxWidgets/3.1.5-GCC-11.2.0"
...
setenv("EBVERSIONWXWIDGETS", "3.1.5")
setenv("EBDEVELWXWIDGETS", pathJoin(root, "logs/wxWidgets-3.1.5-GCC-11.2.0-easybuild-devel"))
