...
local root = "/app/software/ant/1.10.7-Java-11"
...
setenv("EBDEVELANT", pathJoin(root, "logs/ant-1.10.7-Java-11-easybuild-devel"))

setenv("ANT_HOME", "/app/software/ant/1.10.7-Java-11")
