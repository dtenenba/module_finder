...
local root = "/app/software/ant/1.10.12-Java-17"
...
setenv("EBVERSIONANT", "1.10.12")
setenv("EBDEVELANT", pathJoin(root, "logs/ant-1.10.12-Java-17-easybuild-devel"))

setenv("ANT_HOME", "/app/software/ant/1.10.12-Java-17")
