...
local root = "/app/software/ant/1.10.11-Java-11"
...
setenv("EBVERSIONANT", "1.10.11")
setenv("EBDEVELANT", pathJoin(root, "logs/ant-1.10.11-Java-11-easybuild-devel"))

setenv("ANT_HOME", "/app/software/ant/1.10.11-Java-11")
