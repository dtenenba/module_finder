...
local root = "/app/software/Qt5/5.14.2-GCCcore-10.2.0"
...
setenv("EBVERSIONQT5", "5.14.2")
setenv("EBDEVELQT5", pathJoin(root, "logs/Qt5-5.14.2-GCCcore-10.2.0-easybuild-devel"))
