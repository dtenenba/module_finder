...
local root = "/app/software/Qt5/5.13.1-GCCcore-8.3.0"
...
setenv("EBVERSIONQT5", "5.13.1")
setenv("EBDEVELQT5", pathJoin(root, "logs/Qt5-5.13.1-GCCcore-8.3.0-easybuild-devel"))
