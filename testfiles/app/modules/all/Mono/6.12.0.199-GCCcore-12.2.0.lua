...
local root = "/app/software/Mono/6.12.0.199-GCCcore-12.2.0"
...
setenv("EBVERSIONMONO", "6.12.0.199")
setenv("EBDEVELMONO", pathJoin(root, "logs/Mono-6.12.0.199-GCCcore-12.2.0-easybuild-devel"))
