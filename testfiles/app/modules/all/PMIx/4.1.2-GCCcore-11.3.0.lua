...
local root = "/app/software/PMIx/4.1.2-GCCcore-11.3.0"
...
setenv("EBVERSIONPMIX", "4.1.2")
setenv("EBDEVELPMIX", pathJoin(root, "logs/PMIx-4.1.2-GCCcore-11.3.0-easybuild-devel"))
