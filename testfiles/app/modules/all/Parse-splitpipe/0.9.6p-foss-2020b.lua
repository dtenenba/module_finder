...
whatis([==[Extensions: splitpipe-0.9.6p]==])

local root = "/app/software/Parse-splitpipe/0.9.6p-foss-2020b"
...
setenv("EBVERSIONPARSEMINSPLITPIPE", "0.9.6p")
setenv("EBDEVELPARSEMINSPLITPIPE", pathJoin(root, "logs/Parse-splitpipe-0.9.6p-foss-2020b-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.8/site-packages"))
-- Built with EasyBuild version 4.5.2
setenv("EBEXTSLISTPARSEMINSPLITPIPE", "splitpipe-0.9.6p")
