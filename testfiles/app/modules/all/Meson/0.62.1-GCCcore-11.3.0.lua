...
local root = "/app/software/Meson/0.62.1-GCCcore-11.3.0"
...
setenv("EBVERSIONMESON", "0.62.1")
setenv("EBDEVELMESON", pathJoin(root, "logs/Meson-0.62.1-GCCcore-11.3.0-easybuild-devel"))
