...
local root = "/app/software/Meson/1.2.3-GCCcore-13.2.0"
...
if not ( isloaded("Ninja/1.11.1-GCCcore-13.2.0") ) then
    load("Ninja/1.11.1-GCCcore-13.2.0")
end
...
setenv("EBDEVELMESON", pathJoin(root, "logs/Meson-1.2.3-GCCcore-13.2.0-easybuild-devel"))
