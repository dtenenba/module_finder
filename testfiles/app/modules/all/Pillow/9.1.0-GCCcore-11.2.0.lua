...
local root = "/app/software/Pillow/9.1.0-GCCcore-11.2.0"
...
setenv("EBVERSIONPILLOW", "9.1.0")
setenv("EBDEVELPILLOW", pathJoin(root, "logs/Pillow-9.1.0-GCCcore-11.2.0-easybuild-devel"))
