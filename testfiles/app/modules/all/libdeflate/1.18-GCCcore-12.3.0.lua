...
local root = "/app/software/libdeflate/1.18-GCCcore-12.3.0"
...
setenv("EBVERSIONLIBDEFLATE", "1.18")
setenv("EBDEVELLIBDEFLATE", pathJoin(root, "logs/libdeflate-1.18-GCCcore-12.3.0-easybuild-devel"))
