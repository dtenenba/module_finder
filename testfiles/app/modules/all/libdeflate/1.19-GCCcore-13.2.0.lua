...
local root = "/app/software/libdeflate/1.19-GCCcore-13.2.0"
...
setenv("EBVERSIONLIBDEFLATE", "1.19")
setenv("EBDEVELLIBDEFLATE", pathJoin(root, "logs/libdeflate-1.19-GCCcore-13.2.0-easybuild-devel"))
