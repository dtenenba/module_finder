...
local root = "/app/software/LAPACK/3.10.1-GCC-11.2.0"
...
setenv("EBVERSIONLAPACK", "3.10.1")
setenv("EBDEVELLAPACK", pathJoin(root, "logs/LAPACK-3.10.1-GCC-11.2.0-easybuild-devel"))
