...
local root = "/app/software/RE2/2023-08-01-GCCcore-12.3.0"
...
setenv("EBVERSIONRE2", "2023-08-01")
setenv("EBDEVELRE2", pathJoin(root, "logs/RE2-2023-08-01-GCCcore-12.3.0-easybuild-devel"))
