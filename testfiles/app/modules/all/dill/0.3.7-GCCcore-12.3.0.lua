...
local root = "/app/software/dill/0.3.7-GCCcore-12.3.0"
...
setenv("EBVERSIONDILL", "0.3.7")
setenv("EBDEVELDILL", pathJoin(root, "logs/dill-0.3.7-GCCcore-12.3.0-easybuild-devel"))
