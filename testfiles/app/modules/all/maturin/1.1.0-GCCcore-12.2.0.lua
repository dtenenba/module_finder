...
local root = "/app/software/maturin/1.1.0-GCCcore-12.2.0"
...
if not ( isloaded("Rust/1.65.0-GCCcore-12.2.0") ) then
    load("Rust/1.65.0-GCCcore-12.2.0")
end
...
setenv("EBDEVELMATURIN", pathJoin(root, "logs/maturin-1.1.0-GCCcore-12.2.0-easybuild-devel"))
