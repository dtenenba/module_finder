...
local root = "/app/software/maturin/1.4.0-GCCcore-12.3.0-Rust-1.75.0"
...
if not ( isloaded("Rust/1.75.0-GCCcore-12.3.0") ) then
    load("Rust/1.75.0-GCCcore-12.3.0")
end

if not ( isloaded("setuptools-rust/1.6.0-GCCcore-12.3.0") ) then
    load("setuptools-rust/1.6.0-GCCcore-12.3.0")
end

prepend_path("CMAKE_PREFIX_PATH", root)
prepend_path("PATH", pathJoin(root, "bin"))
setenv("EBROOTMATURIN", root)
setenv("EBVERSIONMATURIN", "1.4.0")
setenv("EBDEVELMATURIN", pathJoin(root, "logs/maturin-1.4.0-GCCcore-12.3.0-Rust-1.75.0-easybuild-devel"))
