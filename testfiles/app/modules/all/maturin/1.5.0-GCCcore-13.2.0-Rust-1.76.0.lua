...
local root = "/app/software/maturin/1.5.0-GCCcore-13.2.0-Rust-1.76.0"
...
if not ( isloaded("Rust/1.76.0-GCCcore-13.2.0") ) then
    load("Rust/1.76.0-GCCcore-13.2.0")
end

prepend_path("CMAKE_PREFIX_PATH", root)
prepend_path("PATH", pathJoin(root, "bin"))
setenv("EBROOTMATURIN", root)
setenv("EBVERSIONMATURIN", "1.5.0")
setenv("EBDEVELMATURIN", pathJoin(root, "logs/maturin-1.5.0-GCCcore-13.2.0-Rust-1.76.0-easybuild-devel"))
