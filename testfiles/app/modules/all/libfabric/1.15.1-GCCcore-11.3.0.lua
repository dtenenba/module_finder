...
local root = "/app/software/libfabric/1.15.1-GCCcore-11.3.0"
...
setenv("EBVERSIONLIBFABRIC", "1.15.1")
setenv("EBDEVELLIBFABRIC", pathJoin(root, "logs/libfabric-1.15.1-GCCcore-11.3.0-easybuild-devel"))
