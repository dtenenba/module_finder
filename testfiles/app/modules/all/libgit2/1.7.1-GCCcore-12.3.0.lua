...
local root = "/app/software/libgit2/1.7.1-GCCcore-12.3.0"
...
if not ( isloaded("PCRE/8.45-GCCcore-12.3.0") ) then
    load("PCRE/8.45-GCCcore-12.3.0")
end
...
setenv("EBVERSIONLIBGIT2", "1.7.1")
setenv("EBDEVELLIBGIT2", pathJoin(root, "logs/libgit2-1.7.1-GCCcore-12.3.0-easybuild-devel"))
