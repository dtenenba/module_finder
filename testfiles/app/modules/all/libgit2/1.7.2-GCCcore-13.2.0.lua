...
local root = "/app/software/libgit2/1.7.2-GCCcore-13.2.0"
...
setenv("EBVERSIONLIBGIT2", "1.7.2")
setenv("EBDEVELLIBGIT2", pathJoin(root, "logs/libgit2-1.7.2-GCCcore-13.2.0-easybuild-devel"))
