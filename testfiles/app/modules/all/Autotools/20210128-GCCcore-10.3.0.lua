...
local root = "/app/software/Autotools/20210128-GCCcore-10.3.0"
...
if not ( isloaded("Autoconf/2.71-GCCcore-10.3.0") ) then
    load("Autoconf/2.71-GCCcore-10.3.0")
end

if not ( isloaded("Automake/1.16.3-GCCcore-10.3.0") ) then
    load("Automake/1.16.3-GCCcore-10.3.0")
end

if not ( isloaded("libtool/2.4.6-GCCcore-10.3.0") ) then
    load("libtool/2.4.6-GCCcore-10.3.0")
end

setenv("EBROOTAUTOTOOLS", root)
setenv("EBVERSIONAUTOTOOLS", "20210128")
setenv("EBDEVELAUTOTOOLS", pathJoin(root, "logs/Autotools-20210128-GCCcore-10.3.0-easybuild-devel"))
