...
local root = "/app/software/fhR/4.0.5-foss-2020b"
...
if not ( isloaded("R/4.0.5-foss-2020b") ) then
    load("R/4.0.5-foss-2020b")
end
...
setenv("EBVERSIONFHR", "4.0.5")
setenv("EBDEVELFHR", pathJoin(root, "logs/fhR-4.0.5-foss-2020b-easybuild-devel"))
