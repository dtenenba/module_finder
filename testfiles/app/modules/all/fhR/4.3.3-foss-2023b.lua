...
local root = "/app/software/fhR/4.3.3-foss-2023b"
...
if not ( isloaded("R-Tidyverse/4.3.3-gfbf-2023b") ) then
    load("R-Tidyverse/4.3.3-gfbf-2023b")
end
...
setenv("EBVERSIONFHR", "4.3.3")
setenv("EBDEVELFHR", pathJoin(root, "logs/fhR-4.3.3-foss-2023b-easybuild-devel"))
