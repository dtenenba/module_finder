...
local root = "/app/software/spglib-python/1.16.0-foss-2020b"
...
setenv("EBDEVELSPGLIBMINPYTHON", pathJoin(root, "logs/spglib-python-1.16.0-foss-2020b-easybuild-devel"))
