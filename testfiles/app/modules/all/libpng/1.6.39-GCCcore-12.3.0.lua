...
local root = "/app/software/libpng/1.6.39-GCCcore-12.3.0"
...
setenv("EBVERSIONLIBPNG", "1.6.39")
setenv("EBDEVELLIBPNG", pathJoin(root, "logs/libpng-1.6.39-GCCcore-12.3.0-easybuild-devel"))
