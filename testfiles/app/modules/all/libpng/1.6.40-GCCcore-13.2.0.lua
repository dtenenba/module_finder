...
local root = "/app/software/libpng/1.6.40-GCCcore-13.2.0"
...
setenv("EBVERSIONLIBPNG", "1.6.40")
setenv("EBDEVELLIBPNG", pathJoin(root, "logs/libpng-1.6.40-GCCcore-13.2.0-easybuild-devel"))
