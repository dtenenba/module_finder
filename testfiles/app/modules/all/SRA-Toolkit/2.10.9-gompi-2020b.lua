...
local root = "/app/software/SRA-Toolkit/2.10.9-gompi-2020b"
...
setenv("EBVERSIONSRAMINTOOLKIT", "2.10.9")
setenv("EBDEVELSRAMINTOOLKIT", pathJoin(root, "logs/SRA-Toolkit-2.10.9-gompi-2020b-easybuild-devel"))
