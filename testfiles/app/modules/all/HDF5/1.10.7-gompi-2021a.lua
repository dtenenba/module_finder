...
local root = "/app/software/HDF5/1.10.7-gompi-2021a"
...
if not ( isloaded("Szip/2.1.1-GCCcore-10.3.0") ) then
    load("Szip/2.1.1-GCCcore-10.3.0")
end
...
setenv("EBDEVELHDF5", pathJoin(root, "logs/HDF5-1.10.7-gompi-2021a-easybuild-devel"))

setenv("HDF5_DIR", "/app/software/HDF5/1.10.7-gompi-2021a")
