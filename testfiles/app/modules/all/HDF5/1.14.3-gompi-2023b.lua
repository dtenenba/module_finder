...
local root = "/app/software/HDF5/1.14.3-gompi-2023b"
...
setenv("EBVERSIONHDF5", "1.14.3")
setenv("EBDEVELHDF5", pathJoin(root, "logs/HDF5-1.14.3-gompi-2023b-easybuild-devel"))

setenv("HDF5_DIR", "/app/software/HDF5/1.14.3-gompi-2023b")
