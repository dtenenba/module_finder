...
local root = "/app/software/HDF5/1.14.0-gompi-2023a"
...
if not ( isloaded("Szip/2.1.1-GCCcore-12.3.0") ) then
    load("Szip/2.1.1-GCCcore-12.3.0")
end
...
setenv("EBDEVELHDF5", pathJoin(root, "logs/HDF5-1.14.0-gompi-2023a-easybuild-devel"))

setenv("HDF5_DIR", "/app/software/HDF5/1.14.0-gompi-2023a")
