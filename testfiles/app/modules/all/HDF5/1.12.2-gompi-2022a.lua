...
local root = "/app/software/HDF5/1.12.2-gompi-2022a"
...
if not ( isloaded("Szip/2.1.1-GCCcore-11.3.0") ) then
    load("Szip/2.1.1-GCCcore-11.3.0")
end
...
setenv("EBVERSIONHDF5", "1.12.2")
setenv("EBDEVELHDF5", pathJoin(root, "logs/HDF5-1.12.2-gompi-2022a-easybuild-devel"))

setenv("HDF5_DIR", "/app/software/HDF5/1.12.2-gompi-2022a")
