...
local root = "/app/software/HDF5/1.12.1-gompi-2021b"
...
setenv("EBDEVELHDF5", pathJoin(root, "logs/HDF5-1.12.1-gompi-2021b-easybuild-devel"))

setenv("HDF5_DIR", "/app/software/HDF5/1.12.1-gompi-2021b")
