...
local root = "/app/software/HDF5/1.10.7-gompi-2020b"
...
setenv("EBDEVELHDF5", pathJoin(root, "logs/HDF5-1.10.7-gompi-2020b-easybuild-devel"))

setenv("HDF5_DIR", "/app/software/HDF5/1.10.7-gompi-2020b")
