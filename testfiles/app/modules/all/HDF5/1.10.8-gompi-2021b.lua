...
local root = "/app/software/HDF5/1.10.8-gompi-2021b"
...
setenv("EBVERSIONHDF5", "1.10.8")
setenv("EBDEVELHDF5", pathJoin(root, "logs/HDF5-1.10.8-gompi-2021b-easybuild-devel"))

setenv("HDF5_DIR", "/app/software/HDF5/1.10.8-gompi-2021b")
