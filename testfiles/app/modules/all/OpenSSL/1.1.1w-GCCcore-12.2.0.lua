...
local root = "/app/software/OpenSSL/1.1.1w-GCCcore-12.2.0"
...
setenv("EBVERSIONOPENSSL", "1.1.1w")
setenv("EBDEVELOPENSSL", pathJoin(root, "logs/OpenSSL-1.1.1w-GCCcore-12.2.0-easybuild-devel"))
