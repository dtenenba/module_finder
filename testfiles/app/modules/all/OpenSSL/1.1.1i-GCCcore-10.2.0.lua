...
local root = "/app/software/OpenSSL/1.1.1i-GCCcore-10.2.0"
...
setenv("EBVERSIONOPENSSL", "1.1.1i")
setenv("EBDEVELOPENSSL", pathJoin(root, "logs/OpenSSL-1.1.1i-GCCcore-10.2.0-easybuild-devel"))
