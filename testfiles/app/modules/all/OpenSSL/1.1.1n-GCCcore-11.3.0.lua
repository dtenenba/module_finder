...
local root = "/app/software/OpenSSL/1.1.1n-GCCcore-11.3.0"
...
setenv("EBVERSIONOPENSSL", "1.1.1n")
setenv("EBDEVELOPENSSL", pathJoin(root, "logs/OpenSSL-1.1.1n-GCCcore-11.3.0-easybuild-devel"))
