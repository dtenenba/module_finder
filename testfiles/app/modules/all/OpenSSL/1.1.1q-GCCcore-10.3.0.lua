...
local root = "/app/software/OpenSSL/1.1.1q-GCCcore-10.3.0"
...
setenv("EBVERSIONOPENSSL", "1.1.1q")
setenv("EBDEVELOPENSSL", pathJoin(root, "logs/OpenSSL-1.1.1q-GCCcore-10.3.0-easybuild-devel"))
