...
local root = "/app/software/cairo/1.17.8-GCCcore-12.3.0"
...
if not ( isloaded("pixman/0.42.2-GCCcore-12.3.0") ) then
    load("pixman/0.42.2-GCCcore-12.3.0")
end
...
setenv("EBVERSIONCAIRO", "1.17.8")
setenv("EBDEVELCAIRO", pathJoin(root, "logs/cairo-1.17.8-GCCcore-12.3.0-easybuild-devel"))
