...
local root = "/app/software/cairo/1.16.0-GCCcore-10.3.0"
...
if not ( isloaded("pixman/0.40.0-GCCcore-10.3.0") ) then
    load("pixman/0.40.0-GCCcore-10.3.0")
end

if not ( isloaded("expat/2.2.9-GCCcore-10.3.0") ) then
    load("expat/2.2.9-GCCcore-10.3.0")
end

if not ( isloaded("GLib/2.68.2-GCCcore-10.3.0") ) then
    load("GLib/2.68.2-GCCcore-10.3.0")
end
...
setenv("EBDEVELCAIRO", pathJoin(root, "logs/cairo-1.16.0-GCCcore-10.3.0-easybuild-devel"))
