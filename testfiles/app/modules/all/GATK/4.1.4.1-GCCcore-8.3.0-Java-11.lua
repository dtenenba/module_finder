...
local root = "/app/software/GATK/4.1.4.1-GCCcore-8.3.0-Java-11"
...
prepend_path("CLASSPATH", pathJoin(root, "gatk-package-4.1.4.1-local.jar"))
prepend_path("CLASSPATH", pathJoin(root, "gatk-package-4.1.4.1-spark.jar"))
prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTGATK", root)
setenv("EBVERSIONGATK", "4.1.4.1")
setenv("EBDEVELGATK", pathJoin(root, "logs/GATK-4.1.4.1-GCCcore-8.3.0-Java-11-easybuild-devel"))
