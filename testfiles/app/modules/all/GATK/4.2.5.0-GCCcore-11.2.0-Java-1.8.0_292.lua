...
local root = "/app/software/GATK/4.2.5.0-GCCcore-11.2.0-Java-1.8.0_292"
...
setenv("EBDEVELGATK", pathJoin(root, "logs/GATK-4.2.5.0-GCCcore-11.2.0-Java-1.8.0_292-easybuild-devel"))
