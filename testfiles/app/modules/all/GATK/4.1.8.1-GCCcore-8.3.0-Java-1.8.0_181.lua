...
local root = "/app/software/GATK/4.1.8.1-GCCcore-8.3.0-Java-1.8.0_181"
...
setenv("EBDEVELGATK", pathJoin(root, "logs/GATK-4.1.8.1-GCCcore-8.3.0-Java-1.8.0_181-easybuild-devel"))
