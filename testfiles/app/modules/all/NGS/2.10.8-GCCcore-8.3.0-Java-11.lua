...
local root = "/app/software/NGS/2.10.8-GCCcore-8.3.0-Java-11"
...
setenv("EBVERSIONNGS", "2.10.8")
setenv("EBDEVELNGS", pathJoin(root, "logs/NGS-2.10.8-GCCcore-8.3.0-Java-11-easybuild-devel"))
