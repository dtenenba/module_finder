...
local root = "/app/software/cuDNN/8.9.2.26-CUDA-12.1.1"
...
setenv("EBVERSIONCUDNN", "8.9.2.26")
setenv("EBDEVELCUDNN", pathJoin(root, "logs/cuDNN-8.9.2.26-CUDA-12.1.1-easybuild-devel"))
