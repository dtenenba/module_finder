...
local root = "/app/software/Regenie/3.1.2-GCC-11.2.0"
...
setenv("EBVERSIONREGENIE", "3.1.2")
setenv("EBDEVELREGENIE", pathJoin(root, "logs/Regenie-3.1.2-GCC-11.2.0-easybuild-devel"))
