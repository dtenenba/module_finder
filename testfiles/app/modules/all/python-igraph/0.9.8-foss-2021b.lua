...
whatis([==[Extensions: igraph-0.9.8, texttable-1.6.4]==])

local root = "/app/software/python-igraph/0.9.8-foss-2021b"
...
if not ( isloaded("PyCairo/1.20.1-GCCcore-11.2.0") ) then
    load("PyCairo/1.20.1-GCCcore-11.2.0")
end
...
setenv("EBVERSIONPYTHONMINIGRAPH", "0.9.8")
setenv("EBDEVELPYTHONMINIGRAPH", pathJoin(root, "logs/python-igraph-0.9.8-foss-2021b-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.9/site-packages"))
-- Built with EasyBuild version 4.5.4
setenv("EBEXTSLISTPYTHONMINIGRAPH", "texttable-1.6.4,igraph-0.9.8")
