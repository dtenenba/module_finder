...
local root = "/app/software/zstd/1.5.2-GCCcore-12.2.0"
...
if not ( isloaded("gzip/1.12-GCCcore-12.2.0") ) then
    load("gzip/1.12-GCCcore-12.2.0")
end
...
setenv("EBDEVELZSTD", pathJoin(root, "logs/zstd-1.5.2-GCCcore-12.2.0-easybuild-devel"))
