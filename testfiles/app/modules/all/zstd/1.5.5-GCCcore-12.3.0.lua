...
local root = "/app/software/zstd/1.5.5-GCCcore-12.3.0"
...
if not ( isloaded("gzip/1.12-GCCcore-12.3.0") ) then
    load("gzip/1.12-GCCcore-12.3.0")
end
...
setenv("EBDEVELZSTD", pathJoin(root, "logs/zstd-1.5.5-GCCcore-12.3.0-easybuild-devel"))
