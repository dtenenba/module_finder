...
local root = "/app/software/zstd/1.5.5-GCCcore-13.2.0"
...
if not ( isloaded("gzip/1.13-GCCcore-13.2.0") ) then
    load("gzip/1.13-GCCcore-13.2.0")
end
...
if not ( isloaded("lz4/1.9.4-GCCcore-13.2.0") ) then
    load("lz4/1.9.4-GCCcore-13.2.0")
end
...
setenv("EBVERSIONZSTD", "1.5.5")
setenv("EBDEVELZSTD", pathJoin(root, "logs/zstd-1.5.5-GCCcore-13.2.0-easybuild-devel"))
