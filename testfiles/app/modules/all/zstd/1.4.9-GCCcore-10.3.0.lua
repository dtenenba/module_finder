...
local root = "/app/software/zstd/1.4.9-GCCcore-10.3.0"
...
if not ( isloaded("gzip/1.10-GCCcore-10.3.0") ) then
    load("gzip/1.10-GCCcore-10.3.0")
end
...
if not ( isloaded("lz4/1.9.3-GCCcore-10.3.0") ) then
    load("lz4/1.9.3-GCCcore-10.3.0")
end
...
setenv("EBDEVELZSTD", pathJoin(root, "logs/zstd-1.4.9-GCCcore-10.3.0-easybuild-devel"))
