...
local root = "/app/software/zstd/1.4.5-GCCcore-10.2.0"
...
if not ( isloaded("gzip/1.10-GCCcore-10.2.0") ) then
    load("gzip/1.10-GCCcore-10.2.0")
end
...
setenv("EBDEVELZSTD", pathJoin(root, "logs/zstd-1.4.5-GCCcore-10.2.0-easybuild-devel"))
