...
local root = "/app/software/jemalloc/5.3.0-GCCcore-12.2.0"
...
setenv("EBVERSIONJEMALLOC", "5.3.0")
setenv("EBDEVELJEMALLOC", pathJoin(root, "logs/jemalloc-5.3.0-GCCcore-12.2.0-easybuild-devel"))
