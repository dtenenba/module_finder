...
local root = "/app/software/FlexiBLAS/3.0.4-GCC-10.3.0"
...
if not ( isloaded("OpenBLAS/0.3.15-GCC-10.3.0") ) then
    load("OpenBLAS/0.3.15-GCC-10.3.0")
end
...
setenv("EBDEVELFLEXIBLAS", pathJoin(root, "logs/FlexiBLAS-3.0.4-GCC-10.3.0-easybuild-devel"))
