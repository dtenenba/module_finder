...
local root = "/app/software/FlexiBLAS/3.3.1-GCC-13.2.0"
...
if not ( isloaded("OpenBLAS/0.3.24-GCC-13.2.0") ) then
    load("OpenBLAS/0.3.24-GCC-13.2.0")
end
...
setenv("EBDEVELFLEXIBLAS", pathJoin(root, "logs/FlexiBLAS-3.3.1-GCC-13.2.0-easybuild-devel"))
