...
local root = "/app/software/FlexiBLAS/3.2.1-GCC-12.2.0"
...
if not ( isloaded("OpenBLAS/0.3.21-GCC-12.2.0") ) then
...
setenv("EBDEVELFLEXIBLAS", pathJoin(root, "logs/FlexiBLAS-3.2.1-GCC-12.2.0-easybuild-devel"))
