...
local root = "/app/software/FlexiBLAS/3.3.1-GCC-12.3.0"
...
if not ( isloaded("OpenBLAS/0.3.23-GCC-12.3.0") ) then
...
setenv("EBDEVELFLEXIBLAS", pathJoin(root, "logs/FlexiBLAS-3.3.1-GCC-12.3.0-easybuild-devel"))
