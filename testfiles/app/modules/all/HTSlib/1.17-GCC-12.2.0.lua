...
local root = "/app/software/HTSlib/1.17-GCC-12.2.0"
...
setenv("EBVERSIONHTSLIB", "1.17")
setenv("EBDEVELHTSLIB", pathJoin(root, "logs/HTSlib-1.17-GCC-12.2.0-easybuild-devel"))
