...
local root = "/app/software/HTSlib/1.14-GCC-11.2.0"
...
setenv("EBVERSIONHTSLIB", "1.14")
setenv("EBDEVELHTSLIB", pathJoin(root, "logs/HTSlib-1.14-GCC-11.2.0-easybuild-devel"))
