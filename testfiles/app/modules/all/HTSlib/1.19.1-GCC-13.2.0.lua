...
local root = "/app/software/HTSlib/1.19.1-GCC-13.2.0"
...
setenv("EBVERSIONHTSLIB", "1.19.1")
setenv("EBDEVELHTSLIB", pathJoin(root, "logs/HTSlib-1.19.1-GCC-13.2.0-easybuild-devel"))
