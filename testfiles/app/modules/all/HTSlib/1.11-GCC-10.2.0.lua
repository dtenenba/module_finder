...
local root = "/app/software/HTSlib/1.11-GCC-10.2.0"
...
setenv("EBVERSIONHTSLIB", "1.11")
setenv("EBDEVELHTSLIB", pathJoin(root, "logs/HTSlib-1.11-GCC-10.2.0-easybuild-devel"))
