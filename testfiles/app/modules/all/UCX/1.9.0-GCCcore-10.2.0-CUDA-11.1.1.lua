...
local root = "/app/software/UCX/1.9.0-GCCcore-10.2.0-CUDA-11.1.1"
...
if not ( isloaded("GDRCopy/2.1-GCCcore-10.2.0-CUDA-11.1.1") ) then
    load("GDRCopy/2.1-GCCcore-10.2.0-CUDA-11.1.1")
end
...
setenv("EBDEVELUCX", pathJoin(root, "logs/UCX-1.9.0-GCCcore-10.2.0-CUDA-11.1.1-easybuild-devel"))
