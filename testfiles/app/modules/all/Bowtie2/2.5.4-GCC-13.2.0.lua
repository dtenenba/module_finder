...
local root = "/app/software/Bowtie2/2.5.4-GCC-13.2.0"
...
setenv("EBVERSIONBOWTIE2", "2.5.4")
setenv("EBDEVELBOWTIE2", pathJoin(root, "logs/Bowtie2-2.5.4-GCC-13.2.0-easybuild-devel"))
