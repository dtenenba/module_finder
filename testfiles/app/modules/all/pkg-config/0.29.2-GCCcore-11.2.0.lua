...
local root = "/app/software/pkg-config/0.29.2-GCCcore-11.2.0"
...
setenv("EBDEVELPKGMINCONFIG", pathJoin(root, "logs/pkg-config-0.29.2-GCCcore-11.2.0-easybuild-devel"))
