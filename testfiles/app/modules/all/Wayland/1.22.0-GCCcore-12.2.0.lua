...
local root = "/app/software/Wayland/1.22.0-GCCcore-12.2.0"
...
setenv("EBVERSIONWAYLAND", "1.22.0")
setenv("EBDEVELWAYLAND", pathJoin(root, "logs/Wayland-1.22.0-GCCcore-12.2.0-easybuild-devel"))
