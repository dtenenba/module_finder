...
local root = "/app/software/CoinUtils/2.11.6-GCC-11.2.0"
...
setenv("EBVERSIONCOINUTILS", "2.11.6")
setenv("EBDEVELCOINUTILS", pathJoin(root, "logs/CoinUtils-2.11.6-GCC-11.2.0-easybuild-devel"))
