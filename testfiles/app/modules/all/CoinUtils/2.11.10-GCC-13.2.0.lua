...
local root = "/app/software/CoinUtils/2.11.10-GCC-13.2.0"
...
setenv("EBVERSIONCOINUTILS", "2.11.10")
setenv("EBDEVELCOINUTILS", pathJoin(root, "logs/CoinUtils-2.11.10-GCC-13.2.0-easybuild-devel"))
