...
local root = "/app/software/gzip/1.13-GCCcore-13.2.0"
...
setenv("EBVERSIONGZIP", "1.13")
setenv("EBDEVELGZIP", pathJoin(root, "logs/gzip-1.13-GCCcore-13.2.0-easybuild-devel"))
