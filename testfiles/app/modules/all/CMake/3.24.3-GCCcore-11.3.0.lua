...
local root = "/app/software/CMake/3.24.3-GCCcore-11.3.0"
...
if not ( isloaded("libarchive/3.6.1-GCCcore-11.3.0") ) then
    load("libarchive/3.6.1-GCCcore-11.3.0")
end
...
setenv("EBDEVELCMAKE", pathJoin(root, "logs/CMake-3.24.3-GCCcore-11.3.0-easybuild-devel"))
