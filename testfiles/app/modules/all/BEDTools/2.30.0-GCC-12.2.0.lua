...
local root = "/app/software/BEDTools/2.30.0-GCC-12.2.0"
...
if not ( isloaded("BamTools/2.5.2-GCC-12.2.0") ) then
    load("BamTools/2.5.2-GCC-12.2.0")
end
...
setenv("EBDEVELBEDTOOLS", pathJoin(root, "logs/BEDTools-2.30.0-GCC-12.2.0-easybuild-devel"))
