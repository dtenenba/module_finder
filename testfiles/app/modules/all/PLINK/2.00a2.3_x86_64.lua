...
local root = "/app/software/PLINK/2.00a2.3_x86_64"

conflict("PLINK")

prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTPLINK", root)
setenv("EBVERSIONPLINK", "2.00a2.3_x86_64")
setenv("EBDEVELPLINK", pathJoin(root, "logs/PLINK-2.00a2.3_x86_64-easybuild-devel"))
