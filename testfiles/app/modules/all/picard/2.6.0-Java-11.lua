...
local root = "/app/software/picard/2.6.0-Java-11"
...
setenv("EBDEVELPICARD", pathJoin(root, "logs/picard-2.6.0-Java-11-easybuild-devel"))
...
prepend_path("CLASSPATH", pathJoin(root, "picard-2.6.0.jar"))
