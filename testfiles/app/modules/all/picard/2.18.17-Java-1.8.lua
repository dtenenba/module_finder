...
local root = "/app/software/picard/2.18.17-Java-1.8"
...
setenv("EBVERSIONPICARD", "2.18.17")
setenv("EBDEVELPICARD", pathJoin(root, "/app/logs/picard-2.18.17-Java-1.8-easybuild-devel"))
...
prepend_path("CLASSPATH", pathJoin(root, "picard-2.18.17.jar"))
