...
local root = "/app/software/picard/2.25.0-Java-11"
...
setenv("EBVERSIONPICARD", "2.25.0")
setenv("EBDEVELPICARD", pathJoin(root, "logs/picard-2.25.0-Java-11-easybuild-devel"))
...
prepend_path("CLASSPATH", pathJoin(root, "picard-2.25.0.jar"))
