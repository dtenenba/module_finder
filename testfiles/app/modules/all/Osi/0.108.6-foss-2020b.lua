...
local root = "/app/software/Osi/0.108.6-foss-2020b"
...
if not ( isloaded("CoinUtils/2.11.4-foss-2020b") ) then
    load("CoinUtils/2.11.4-foss-2020b")
end
...
setenv("EBDEVELOSI", pathJoin(root, "logs/Osi-0.108.6-foss-2020b-easybuild-devel"))
