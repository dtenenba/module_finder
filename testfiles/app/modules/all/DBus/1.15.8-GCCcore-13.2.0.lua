...
local root = "/app/software/DBus/1.15.8-GCCcore-13.2.0"
...
setenv("EBVERSIONDBUS", "1.15.8")
setenv("EBDEVELDBUS", pathJoin(root, "logs/DBus-1.15.8-GCCcore-13.2.0-easybuild-devel"))
