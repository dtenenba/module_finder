...
local root = "/app/software/DBus/1.15.4-GCCcore-12.3.0"
...
setenv("EBVERSIONDBUS", "1.15.4")
setenv("EBDEVELDBUS", pathJoin(root, "logs/DBus-1.15.4-GCCcore-12.3.0-easybuild-devel"))
