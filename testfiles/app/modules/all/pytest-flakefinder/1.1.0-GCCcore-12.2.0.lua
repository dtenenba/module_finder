...
local root = "/app/software/pytest-flakefinder/1.1.0-GCCcore-12.2.0"
...
setenv("EBDEVELPYTESTMINFLAKEFINDER", pathJoin(root, "logs/pytest-flakefinder-1.1.0-GCCcore-12.2.0-easybuild-devel"))
