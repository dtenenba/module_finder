...
local root = "/app/software/at-spi2-atk/2.38.0-GCCcore-12.2.0"
...
if not ( isloaded("at-spi2-core/2.46.0-GCCcore-12.2.0") ) then
    load("at-spi2-core/2.46.0-GCCcore-12.2.0")
end
...
setenv("EBDEVELATMINSPI2MINATK", pathJoin(root, "logs/at-spi2-atk-2.38.0-GCCcore-12.2.0-easybuild-devel"))
