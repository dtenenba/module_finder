...
local root = "/app/software/hwloc/2.9.1-GCCcore-12.3.0"
...
setenv("EBVERSIONHWLOC", "2.9.1")
setenv("EBDEVELHWLOC", pathJoin(root, "logs/hwloc-2.9.1-GCCcore-12.3.0-easybuild-devel"))
