...
local root = "/app/software/hwloc/2.7.1-GCCcore-11.3.0"
...
setenv("EBVERSIONHWLOC", "2.7.1")
setenv("EBDEVELHWLOC", pathJoin(root, "logs/hwloc-2.7.1-GCCcore-11.3.0-easybuild-devel"))
