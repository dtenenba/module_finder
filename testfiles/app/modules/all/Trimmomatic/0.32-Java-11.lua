...
local root = "/app/software/Trimmomatic/0.32-Java-11"
...
prepend_path("CLASSPATH", pathJoin(root, "trimmomatic-0.32.jar"))
prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTTRIMMOMATIC", root)
setenv("EBVERSIONTRIMMOMATIC", "0.32")
setenv("EBDEVELTRIMMOMATIC", pathJoin(root, "logs/Trimmomatic-0.32-Java-11-easybuild-devel"))


if mode() == "load" then
io.stderr:write([==[To execute Trimmomatic run: java -jar $EBROOTTRIMMOMATIC/trimmomatic-0.32.jar
]==])
end
