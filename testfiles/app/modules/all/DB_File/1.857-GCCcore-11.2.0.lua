...
local root = "/app/software/DB_File/1.857-GCCcore-11.2.0"
...
if not ( isloaded("DB/18.1.40-GCCcore-11.2.0") ) then
    load("DB/18.1.40-GCCcore-11.2.0")
end
...
setenv("EBVERSIONDB_FILE", "1.857")
setenv("EBDEVELDB_FILE", pathJoin(root, "logs/DB_File-1.857-GCCcore-11.2.0-easybuild-devel"))
