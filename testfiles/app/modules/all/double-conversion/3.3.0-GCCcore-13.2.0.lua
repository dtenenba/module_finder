...
local root = "/app/software/double-conversion/3.3.0-GCCcore-13.2.0"
...
setenv("EBVERSIONDOUBLEMINCONVERSION", "3.3.0")
setenv("EBDEVELDOUBLEMINCONVERSION", pathJoin(root, "logs/double-conversion-3.3.0-GCCcore-13.2.0-easybuild-devel"))
