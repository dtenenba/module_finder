...
local root = "/app/software/double-conversion/3.1.5-GCCcore-9.3.0"
...
setenv("EBDEVELDOUBLEMINCONVERSION", pathJoin(root, "logs/double-conversion-3.1.5-GCCcore-9.3.0-easybuild-devel"))
