...
local root = "/app/software/double-conversion/3.2.1-GCCcore-12.2.0"
...
setenv("EBDEVELDOUBLEMINCONVERSION", pathJoin(root, "logs/double-conversion-3.2.1-GCCcore-12.2.0-easybuild-devel"))
