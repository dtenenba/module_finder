...
local root = "/app/software/double-conversion/3.3.0-GCCcore-12.3.0"
...
setenv("EBDEVELDOUBLEMINCONVERSION", pathJoin(root, "logs/double-conversion-3.3.0-GCCcore-12.3.0-easybuild-devel"))
