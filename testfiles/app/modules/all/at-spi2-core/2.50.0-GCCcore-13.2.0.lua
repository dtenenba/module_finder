...
local root = "/app/software/at-spi2-core/2.50.0-GCCcore-13.2.0"
...
setenv("EBVERSIONATMINSPI2MINCORE", "2.50.0")
setenv("EBDEVELATMINSPI2MINCORE", pathJoin(root, "logs/at-spi2-core-2.50.0-GCCcore-13.2.0-easybuild-devel"))
