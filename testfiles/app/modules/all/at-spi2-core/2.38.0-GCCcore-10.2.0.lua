...
local root = "/app/software/at-spi2-core/2.38.0-GCCcore-10.2.0"
...
setenv("EBVERSIONATMINSPI2MINCORE", "2.38.0")
setenv("EBDEVELATMINSPI2MINCORE", pathJoin(root, "logs/at-spi2-core-2.38.0-GCCcore-10.2.0-easybuild-devel"))
