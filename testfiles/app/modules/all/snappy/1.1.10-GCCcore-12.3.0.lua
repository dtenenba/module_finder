...
local root = "/app/software/snappy/1.1.10-GCCcore-12.3.0"
...
setenv("EBVERSIONSNAPPY", "1.1.10")
setenv("EBDEVELSNAPPY", pathJoin(root, "logs/snappy-1.1.10-GCCcore-12.3.0-easybuild-devel"))
