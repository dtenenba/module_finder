...
local root = "/app/software/libwebp/1.2.4-GCCcore-11.3.0"
...
setenv("EBVERSIONLIBWEBP", "1.2.4")
setenv("EBDEVELLIBWEBP", pathJoin(root, "logs/libwebp-1.2.4-GCCcore-11.3.0-easybuild-devel"))
