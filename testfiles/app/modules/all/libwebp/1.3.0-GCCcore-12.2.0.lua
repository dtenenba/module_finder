...
local root = "/app/software/libwebp/1.3.0-GCCcore-12.2.0"
...
setenv("EBVERSIONLIBWEBP", "1.3.0")
setenv("EBDEVELLIBWEBP", pathJoin(root, "logs/libwebp-1.3.0-GCCcore-12.2.0-easybuild-devel"))
