...
local root = "/app/software/libwebp/1.3.2-GCCcore-13.2.0"
...
setenv("EBVERSIONLIBWEBP", "1.3.2")
setenv("EBDEVELLIBWEBP", pathJoin(root, "logs/libwebp-1.3.2-GCCcore-13.2.0-easybuild-devel"))
