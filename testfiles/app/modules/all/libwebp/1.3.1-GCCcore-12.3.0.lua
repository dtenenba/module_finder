...
local root = "/app/software/libwebp/1.3.1-GCCcore-12.3.0"
...
if not ( isloaded("giflib/5.2.1-GCCcore-12.3.0") ) then
    load("giflib/5.2.1-GCCcore-12.3.0")
end
...
setenv("EBVERSIONLIBWEBP", "1.3.1")
setenv("EBDEVELLIBWEBP", pathJoin(root, "logs/libwebp-1.3.1-GCCcore-12.3.0-easybuild-devel"))
