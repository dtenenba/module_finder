...
local root = "/app/software/libwebp/1.2.0-GCCcore-11.2.0"
...
setenv("EBVERSIONLIBWEBP", "1.2.0")
setenv("EBDEVELLIBWEBP", pathJoin(root, "logs/libwebp-1.2.0-GCCcore-11.2.0-easybuild-devel"))
