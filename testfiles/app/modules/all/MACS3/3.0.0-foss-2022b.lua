...
Included extensions
===================
cykhash-2.0.1, Cython-3.0.8, hmmlearn-0.3.0, MACS3-3.0.0
]==])
...
whatis([==[Extensions: cykhash-2.0.1, Cython-3.0.8, hmmlearn-0.3.0, MACS3-3.0.0]==])

local root = "/app/software/MACS3/3.0.0-foss-2022b"
...
setenv("EBVERSIONMACS3", "3.0.0")
setenv("EBDEVELMACS3", pathJoin(root, "logs/MACS3-3.0.0-foss-2022b-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.10/site-packages"))
-- Built with EasyBuild version 4.9.0
setenv("EBEXTSLISTMACS3", "Cython-3.0.8,cykhash-2.0.1,hmmlearn-0.3.0,MACS3-3.0.0")
