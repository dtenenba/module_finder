...
local root = "/app/software/libxslt/1.1.38-GCCcore-12.3.0"
...
setenv("EBVERSIONLIBXSLT", "1.1.38")
setenv("EBDEVELLIBXSLT", pathJoin(root, "logs/libxslt-1.1.38-GCCcore-12.3.0-easybuild-devel"))
