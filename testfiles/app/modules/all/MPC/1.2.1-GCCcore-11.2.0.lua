...
local root = "/app/software/MPC/1.2.1-GCCcore-11.2.0"
...
setenv("EBVERSIONMPC", "1.2.1")
setenv("EBDEVELMPC", pathJoin(root, "logs/MPC-1.2.1-GCCcore-11.2.0-easybuild-devel"))
