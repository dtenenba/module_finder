...
local root = "/app/software/MPC/1.3.1-GCCcore-12.3.0"
...
setenv("EBVERSIONMPC", "1.3.1")
setenv("EBDEVELMPC", pathJoin(root, "logs/MPC-1.3.1-GCCcore-12.3.0-easybuild-devel"))
