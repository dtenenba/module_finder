...
Included extensions
===================
et_xmlfile-1.1.0, leidenalg-0.8.10, louvain-0.7.1, networkx-2.8.4,
openpyxl-3.0.9, splitpipe-1.0.6p
]==])
...
whatis([==[Extensions: et_xmlfile-1.1.0, leidenalg-0.8.10, louvain-0.7.1, networkx-2.8.4, openpyxl-3.0.9, splitpipe-1.0.6p]==])

local root = "/app/software/splitpipe/1.0.6p-foss-2021b"
...
setenv("EBVERSIONSPLITPIPE", "1.0.6p")
setenv("EBDEVELSPLITPIPE", pathJoin(root, "logs/splitpipe-1.0.6p-foss-2021b-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.9/site-packages"))
-- Built with EasyBuild version 4.7.1
setenv("EBEXTSLISTSPLITPIPE", "networkx-2.8.4,leidenalg-0.8.10,louvain-0.7.1,et_xmlfile-1.1.0,openpyxl-3.0.9,splitpipe-1.0.6p")
