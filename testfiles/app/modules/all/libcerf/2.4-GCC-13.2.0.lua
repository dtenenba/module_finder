...
local root = "/app/software/libcerf/2.4-GCC-13.2.0"
...
setenv("EBVERSIONLIBCERF", "2.4")
setenv("EBDEVELLIBCERF", pathJoin(root, "logs/libcerf-2.4-GCC-13.2.0-easybuild-devel"))
