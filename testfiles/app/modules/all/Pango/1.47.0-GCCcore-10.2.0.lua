...
local root = "/app/software/Pango/1.47.0-GCCcore-10.2.0"
...
if not ( isloaded("HarfBuzz/2.6.7-GCCcore-10.2.0") ) then
    load("HarfBuzz/2.6.7-GCCcore-10.2.0")
end
...
setenv("EBDEVELPANGO", pathJoin(root, "logs/Pango-1.47.0-GCCcore-10.2.0-easybuild-devel"))
