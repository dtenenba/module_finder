...
local root = "/app/software/Pango/1.50.14-GCCcore-12.3.0"
...
setenv("EBVERSIONPANGO", "1.50.14")
setenv("EBDEVELPANGO", pathJoin(root, "logs/Pango-1.50.14-GCCcore-12.3.0-easybuild-devel"))
