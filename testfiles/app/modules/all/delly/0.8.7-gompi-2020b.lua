...
local root = "/app/software/Delly/0.8.7-gompi-2020b"
...
setenv("EBVERSIONDELLY", "0.8.7")
setenv("EBDEVELDELLY", pathJoin(root, "logs/Delly-0.8.7-gompi-2020b-easybuild-devel"))
