...
local root = "/app/software/Hypre/2.21.0-foss-2021a"
...
setenv("EBVERSIONHYPRE", "2.21.0")
setenv("EBDEVELHYPRE", pathJoin(root, "logs/Hypre-2.21.0-foss-2021a-easybuild-devel"))
