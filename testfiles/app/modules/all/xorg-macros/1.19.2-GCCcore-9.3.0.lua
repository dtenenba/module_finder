...
local root = "/app/software/xorg-macros/1.19.2-GCCcore-9.3.0"
...
setenv("EBDEVELXORGMINMACROS", pathJoin(root, "logs/xorg-macros-1.19.2-GCCcore-9.3.0-easybuild-devel"))
