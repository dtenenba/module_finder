...
local root = "/app/software/xorg-macros/1.19.3-GCCcore-11.2.0"
...
setenv("EBDEVELXORGMINMACROS", pathJoin(root, "logs/xorg-macros-1.19.3-GCCcore-11.2.0-easybuild-devel"))
