...
local root = "/app/software/xorg-macros/1.20.0-GCCcore-13.2.0"
...
setenv("EBDEVELXORGMINMACROS", pathJoin(root, "logs/xorg-macros-1.20.0-GCCcore-13.2.0-easybuild-devel"))
