...
local root = "/app/software/xorg-macros/1.19.2-GCCcore-10.2.0"
...
setenv("EBDEVELXORGMINMACROS", pathJoin(root, "logs/xorg-macros-1.19.2-GCCcore-10.2.0-easybuild-devel"))
