...
local root = "/app/software/BBMap/38.91-GCC-10.2.0"
...
setenv("EBVERSIONBBMAP", "38.91")
setenv("EBDEVELBBMAP", pathJoin(root, "logs/BBMap-38.91-GCC-10.2.0-easybuild-devel"))
