...
local root = "/app/software/ZeroMQ/4.3.4-GCCcore-11.3.0"
...
if not ( isloaded("OpenPGM/5.2.122-GCCcore-11.3.0") ) then
    load("OpenPGM/5.2.122-GCCcore-11.3.0")
end

if not ( isloaded("libsodium/1.0.18-GCCcore-11.3.0") ) then
    load("libsodium/1.0.18-GCCcore-11.3.0")
end
...
setenv("EBDEVELZEROMQ", pathJoin(root, "logs/ZeroMQ-4.3.4-GCCcore-11.3.0-easybuild-devel"))
