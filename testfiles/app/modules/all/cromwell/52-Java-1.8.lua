...
local root = "/app/software/cromwell/52-Java-1.8"
...
prepend_path("CLASSPATH", pathJoin(root, "cromwell-52.jar"))
prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTCROMWELL", root)
setenv("EBVERSIONCROMWELL", "52")
setenv("EBDEVELCROMWELL", pathJoin(root, "logs/cromwell-52-Java-1.8-easybuild-devel"))


if mode() == "load" then
io.stderr:write([==[To execute cromwell run: java -jar $EBROOTCROMWELL/cromwell-52.jar
]==])
end
