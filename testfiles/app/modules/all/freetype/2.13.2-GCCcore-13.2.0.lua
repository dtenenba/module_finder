...
local root = "/app/software/freetype/2.13.2-GCCcore-13.2.0"
...
setenv("EBVERSIONFREETYPE", "2.13.2")
setenv("EBDEVELFREETYPE", pathJoin(root, "logs/freetype-2.13.2-GCCcore-13.2.0-easybuild-devel"))
