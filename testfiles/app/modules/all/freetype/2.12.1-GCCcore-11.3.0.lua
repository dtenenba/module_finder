...
local root = "/app/software/freetype/2.12.1-GCCcore-11.3.0"
...
if not ( isloaded("Brotli/1.0.9-GCCcore-11.3.0") ) then
    load("Brotli/1.0.9-GCCcore-11.3.0")
end
...
setenv("EBDEVELFREETYPE", pathJoin(root, "logs/freetype-2.12.1-GCCcore-11.3.0-easybuild-devel"))
