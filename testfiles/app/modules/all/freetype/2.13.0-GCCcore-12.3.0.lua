...
local root = "/app/software/freetype/2.13.0-GCCcore-12.3.0"
...
if not ( isloaded("Brotli/1.0.9-GCCcore-12.3.0") ) then
    load("Brotli/1.0.9-GCCcore-12.3.0")
end
...
setenv("EBVERSIONFREETYPE", "2.13.0")
setenv("EBDEVELFREETYPE", pathJoin(root, "logs/freetype-2.13.0-GCCcore-12.3.0-easybuild-devel"))
