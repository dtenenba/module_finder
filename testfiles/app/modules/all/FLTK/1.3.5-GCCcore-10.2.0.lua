...
local root = "/app/software/FLTK/1.3.5-GCCcore-10.2.0"
...
if not ( isloaded("xprop/1.2.5-GCCcore-10.2.0") ) then
    load("xprop/1.2.5-GCCcore-10.2.0")
end
...
setenv("EBDEVELFLTK", pathJoin(root, "logs/FLTK-1.3.5-GCCcore-10.2.0-easybuild-devel"))
