...
local root = "/app/software/protobuf-python/4.23.0-GCCcore-12.2.0"
...
setenv("EBVERSIONPROTOBUFMINPYTHON", "4.23.0")
setenv("EBDEVELPROTOBUFMINPYTHON", pathJoin(root, "logs/protobuf-python-4.23.0-GCCcore-12.2.0-easybuild-devel"))
