...
local root = "/app/software/protobuf-python/3.17.3-GCCcore-10.3.0"
...
setenv("EBDEVELPROTOBUFMINPYTHON", pathJoin(root, "logs/protobuf-python-3.17.3-GCCcore-10.3.0-easybuild-devel"))
