...
local root = "/app/software/Graphviz/7.0.6-GCCcore-12.2.0"
...
if not ( isloaded("GTS/0.7.6-GCCcore-12.2.0") ) then
    load("GTS/0.7.6-GCCcore-12.2.0")
end
...
if not ( isloaded("librsvg/2.56.0-GCCcore-12.2.0") ) then
    load("librsvg/2.56.0-GCCcore-12.2.0")
end
...
setenv("EBVERSIONGRAPHVIZ", "7.0.6")
setenv("EBDEVELGRAPHVIZ", pathJoin(root, "logs/Graphviz-7.0.6-GCCcore-12.2.0-easybuild-devel"))
