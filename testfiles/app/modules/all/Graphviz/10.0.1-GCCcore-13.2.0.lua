...
local root = "/app/software/Graphviz/10.0.1-GCCcore-13.2.0"
...
if not ( isloaded("GTS/0.7.6-GCCcore-13.2.0") ) then
    load("GTS/0.7.6-GCCcore-13.2.0")
end

if not ( isloaded("libgd/2.3.3-GCCcore-13.2.0") ) then
    load("libgd/2.3.3-GCCcore-13.2.0")
end
...
if not ( isloaded("Tcl/8.6.13-GCCcore-13.2.0") ) then
    load("Tcl/8.6.13-GCCcore-13.2.0")
end
...
setenv("EBVERSIONGRAPHVIZ", "10.0.1")
setenv("EBDEVELGRAPHVIZ", pathJoin(root, "logs/Graphviz-10.0.1-GCCcore-13.2.0-easybuild-devel"))
