...
local root = "/app/software/GObject-Introspection/1.78.1-GCCcore-13.2.0"
...
setenv("EBVERSIONGOBJECTMININTROSPECTION", "1.78.1")
setenv("EBDEVELGOBJECTMININTROSPECTION", pathJoin(root, "logs/GObject-Introspection-1.78.1-GCCcore-13.2.0-easybuild-devel"))
