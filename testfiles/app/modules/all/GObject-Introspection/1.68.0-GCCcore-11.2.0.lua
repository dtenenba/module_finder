...
local root = "/app/software/GObject-Introspection/1.68.0-GCCcore-11.2.0"
...
setenv("EBDEVELGOBJECTMININTROSPECTION", pathJoin(root, "logs/GObject-Introspection-1.68.0-GCCcore-11.2.0-easybuild-devel"))
