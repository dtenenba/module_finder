...
local root = "/app/software/GObject-Introspection/1.66.1-GCCcore-10.2.0"
...
setenv("EBDEVELGOBJECTMININTROSPECTION", pathJoin(root, "logs/GObject-Introspection-1.66.1-GCCcore-10.2.0-easybuild-devel"))
