...
local root = "/app/software/GObject-Introspection/1.76.1-GCCcore-12.3.0"
...
setenv("EBVERSIONGOBJECTMININTROSPECTION", "1.76.1")
setenv("EBDEVELGOBJECTMININTROSPECTION", pathJoin(root, "logs/GObject-Introspection-1.76.1-GCCcore-12.3.0-easybuild-devel"))
