...
local root = "/app/software/GObject-Introspection/1.74.0-GCCcore-12.2.0"
...
setenv("EBDEVELGOBJECTMININTROSPECTION", pathJoin(root, "logs/GObject-Introspection-1.74.0-GCCcore-12.2.0-easybuild-devel"))
