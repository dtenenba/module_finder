...
local root = "/app/software/GObject-Introspection/1.58.3-GCCcore-8.3.0-Python-2.7.16"
...
setenv("EBVERSIONGOBJECTMININTROSPECTION", "1.58.3")
setenv("EBDEVELGOBJECTMININTROSPECTION", pathJoin(root, "logs/GObject-Introspection-1.58.3-GCCcore-8.3.0-Python-2.7.16-easybuild-devel"))
