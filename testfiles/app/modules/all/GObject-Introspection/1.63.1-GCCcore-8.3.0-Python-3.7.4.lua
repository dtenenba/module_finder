...
local root = "/app/software/GObject-Introspection/1.63.1-GCCcore-8.3.0-Python-3.7.4"
...
setenv("EBVERSIONGOBJECTMININTROSPECTION", "1.63.1")
setenv("EBDEVELGOBJECTMININTROSPECTION", pathJoin(root, "logs/GObject-Introspection-1.63.1-GCCcore-8.3.0-Python-3.7.4-easybuild-devel"))
