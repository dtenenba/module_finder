...
local root = "/app/software/libvorbis/1.3.7-GCCcore-11.2.0"
...
if not ( isloaded("libogg/1.3.5-GCCcore-11.2.0") ) then
    load("libogg/1.3.5-GCCcore-11.2.0")
end
...
setenv("EBDEVELLIBVORBIS", pathJoin(root, "logs/libvorbis-1.3.7-GCCcore-11.2.0-easybuild-devel"))
