...
local root = "/app/software/JsonCpp/1.9.3-GCCcore-8.3.0"
...
setenv("EBVERSIONJSONCPP", "1.9.3")
setenv("EBDEVELJSONCPP", pathJoin(root, "logs/JsonCpp-1.9.3-GCCcore-8.3.0-easybuild-devel"))
