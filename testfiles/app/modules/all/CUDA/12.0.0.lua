...
local root = "/app/software/CUDA/12.0.0"
...
setenv("EBDEVELCUDA", pathJoin(root, "logs/CUDA-12.0.0-easybuild-devel"))

setenv("CUDA_HOME", "/app/software/CUDA/12.0.0")
setenv("CUDA_ROOT", "/app/software/CUDA/12.0.0")
setenv("CUDA_PATH", "/app/software/CUDA/12.0.0")
