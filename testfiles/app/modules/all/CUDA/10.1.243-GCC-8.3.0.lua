...
local root = "/app/software/CUDA/10.1.243-GCC-8.3.0"
...
setenv("EBDEVELCUDA", pathJoin(root, "logs/CUDA-10.1.243-GCC-8.3.0-easybuild-devel"))

prepend_path("PATH", root)
setenv("CUDA_HOME", "/app/software/CUDA/10.1.243-GCC-8.3.0")
setenv("CUDA_ROOT", "/app/software/CUDA/10.1.243-GCC-8.3.0")
setenv("CUDA_PATH", "/app/software/CUDA/10.1.243-GCC-8.3.0")
