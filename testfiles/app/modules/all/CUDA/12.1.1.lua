...
local root = "/app/software/CUDA/12.1.1"
...
setenv("EBVERSIONCUDA", "12.1.1")
setenv("EBDEVELCUDA", pathJoin(root, "logs/CUDA-12.1.1-easybuild-devel"))

setenv("CUDA_HOME", "/app/software/CUDA/12.1.1")
setenv("CUDA_ROOT", "/app/software/CUDA/12.1.1")
setenv("CUDA_PATH", "/app/software/CUDA/12.1.1")
