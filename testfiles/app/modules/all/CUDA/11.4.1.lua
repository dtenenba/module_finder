...
local root = "/app/software/CUDA/11.4.1"
...
setenv("EBDEVELCUDA", pathJoin(root, "logs/CUDA-11.4.1-easybuild-devel"))

setenv("CUDA_HOME", "/app/software/CUDA/11.4.1")
setenv("CUDA_ROOT", "/app/software/CUDA/11.4.1")
setenv("CUDA_PATH", "/app/software/CUDA/11.4.1")
