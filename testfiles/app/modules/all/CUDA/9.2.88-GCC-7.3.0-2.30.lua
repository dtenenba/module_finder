...
local root = "/app/software/CUDA/9.2.88-GCC-7.3.0-2.30"
...
setenv("EBDEVELCUDA", pathJoin(root, "/app/logs/CUDA-9.2.88-GCC-7.3.0-2.30-easybuild-devel"))

prepend_path("PATH", root)
setenv("CUDA_HOME", "/app/software/CUDA/9.2.88-GCC-7.3.0-2.30")
setenv("CUDA_ROOT", "/app/software/CUDA/9.2.88-GCC-7.3.0-2.30")
setenv("CUDA_PATH", "/app/software/CUDA/9.2.88-GCC-7.3.0-2.30")
