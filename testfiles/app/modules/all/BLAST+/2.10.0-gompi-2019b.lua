...
local root = "/app/software/BLAST+/2.10.0-gompi-2019b"
...
setenv("EBVERSIONBLASTPLUS", "2.10.0")
setenv("EBDEVELBLASTPLUS", pathJoin(root, "logs/BLAST+-2.10.0-gompi-2019b-easybuild-devel"))
