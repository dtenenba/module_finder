...
local root = "/app/software/libgpg-error/1.37-GCCcore-8.3.0"
...
setenv("EBVERSIONLIBGPGMINERROR", "1.37")
setenv("EBDEVELLIBGPGMINERROR", pathJoin(root, "logs/libgpg-error-1.37-GCCcore-8.3.0-easybuild-devel"))
