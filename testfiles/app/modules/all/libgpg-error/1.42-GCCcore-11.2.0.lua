...
local root = "/app/software/libgpg-error/1.42-GCCcore-11.2.0"
...
setenv("EBVERSIONLIBGPGMINERROR", "1.42")
setenv("EBDEVELLIBGPGMINERROR", pathJoin(root, "logs/libgpg-error-1.42-GCCcore-11.2.0-easybuild-devel"))
