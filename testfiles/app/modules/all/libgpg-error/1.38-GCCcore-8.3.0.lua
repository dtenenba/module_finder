...
local root = "/app/software/libgpg-error/1.38-GCCcore-8.3.0"
...
setenv("EBVERSIONLIBGPGMINERROR", "1.38")
setenv("EBDEVELLIBGPGMINERROR", pathJoin(root, "logs/libgpg-error-1.38-GCCcore-8.3.0-easybuild-devel"))
