...
local root = "/app/software/pkgconf/1.9.5-GCCcore-12.3.0"
...
setenv("EBVERSIONPKGCONF", "1.9.5")
setenv("EBDEVELPKGCONF", pathJoin(root, "logs/pkgconf-1.9.5-GCCcore-12.3.0-easybuild-devel"))
