...
local root = "/app/software/kallisto/0.48.0-foss-2020b"
...
setenv("EBVERSIONKALLISTO", "0.48.0")
setenv("EBDEVELKALLISTO", pathJoin(root, "logs/kallisto-0.48.0-foss-2020b-easybuild-devel"))
