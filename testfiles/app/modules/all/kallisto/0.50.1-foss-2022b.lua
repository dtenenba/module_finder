...
local root = "/app/software/kallisto/0.50.1-foss-2022b"
...
setenv("EBVERSIONKALLISTO", "0.50.1")
setenv("EBDEVELKALLISTO", pathJoin(root, "logs/kallisto-0.50.1-foss-2022b-easybuild-devel"))
