...
local root = "/app/software/Abseil/20230125.2-GCCcore-12.2.0"
...
setenv("EBVERSIONABSEIL", "20230125.2")
setenv("EBDEVELABSEIL", pathJoin(root, "logs/Abseil-20230125.2-GCCcore-12.2.0-easybuild-devel"))
