...
local root = "/app/software/Abseil/20240116.1-GCCcore-13.2.0"
...
setenv("EBVERSIONABSEIL", "20240116.1")
setenv("EBDEVELABSEIL", pathJoin(root, "logs/Abseil-20240116.1-GCCcore-13.2.0-easybuild-devel"))
