...
local root = "/app/software/LibTIFF/4.2.0-GCCcore-10.3.0"
...
if not ( isloaded("libjpeg-turbo/2.0.6-GCCcore-10.3.0") ) then
    load("libjpeg-turbo/2.0.6-GCCcore-10.3.0")
end
...
if not ( isloaded("jbigkit/2.1-GCCcore-10.3.0") ) then
    load("jbigkit/2.1-GCCcore-10.3.0")
end
...
setenv("EBDEVELLIBTIFF", pathJoin(root, "logs/LibTIFF-4.2.0-GCCcore-10.3.0-easybuild-devel"))
