...
local root = "/app/software/Rust/1.70.0-GCCcore-12.3.0"
...
setenv("EBVERSIONRUST", "1.70.0")
setenv("EBDEVELRUST", pathJoin(root, "logs/Rust-1.70.0-GCCcore-12.3.0-easybuild-devel"))
