...
local root = "/app/software/Rust/1.49.0-GCCcore-10.2.0"
...
setenv("EBVERSIONRUST", "1.49.0")
setenv("EBDEVELRUST", pathJoin(root, "logs/Rust-1.49.0-GCCcore-10.2.0-easybuild-devel"))
