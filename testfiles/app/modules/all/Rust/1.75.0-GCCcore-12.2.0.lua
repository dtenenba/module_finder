...
local root = "/app/software/Rust/1.75.0-GCCcore-12.2.0"
...
setenv("EBVERSIONRUST", "1.75.0")
setenv("EBDEVELRUST", pathJoin(root, "logs/Rust-1.75.0-GCCcore-12.2.0-easybuild-devel"))
