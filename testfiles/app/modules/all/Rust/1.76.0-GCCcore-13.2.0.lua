...
local root = "/app/software/Rust/1.76.0-GCCcore-13.2.0"
...
setenv("EBVERSIONRUST", "1.76.0")
setenv("EBDEVELRUST", pathJoin(root, "logs/Rust-1.76.0-GCCcore-13.2.0-easybuild-devel"))
