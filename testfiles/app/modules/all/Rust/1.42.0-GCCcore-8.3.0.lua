...
local root = "/app/software/Rust/1.42.0-GCCcore-8.3.0"
...
setenv("EBVERSIONRUST", "1.42.0")
setenv("EBDEVELRUST", pathJoin(root, "logs/Rust-1.42.0-GCCcore-8.3.0-easybuild-devel"))
