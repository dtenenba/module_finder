...
local root = "/app/software/scikit-build/0.17.2-GCCcore-12.2.0"
...
setenv("EBDEVELSCIKITMINBUILD", pathJoin(root, "logs/scikit-build-0.17.2-GCCcore-12.2.0-easybuild-devel"))
