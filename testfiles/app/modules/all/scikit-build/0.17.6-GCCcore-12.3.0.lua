...
local root = "/app/software/scikit-build/0.17.6-GCCcore-12.3.0"
...
setenv("EBDEVELSCIKITMINBUILD", pathJoin(root, "logs/scikit-build-0.17.6-GCCcore-12.3.0-easybuild-devel"))
