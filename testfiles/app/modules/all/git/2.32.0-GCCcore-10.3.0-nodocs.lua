...
local root = "/app/software/git/2.32.0-GCCcore-10.3.0-nodocs"
...
if not ( isloaded("cURL/7.76.0-GCCcore-10.3.0") ) then
    load("cURL/7.76.0-GCCcore-10.3.0")
end
...
if not ( isloaded("Perl/5.32.1-GCCcore-10.3.0") ) then
    load("Perl/5.32.1-GCCcore-10.3.0")
end
...
setenv("EBDEVELGIT", pathJoin(root, "logs/git-2.32.0-GCCcore-10.3.0-nodocs-easybuild-devel"))
