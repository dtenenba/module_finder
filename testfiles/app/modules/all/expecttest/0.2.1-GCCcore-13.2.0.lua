...
local root = "/app/software/expecttest/0.2.1-GCCcore-13.2.0"
...
setenv("EBVERSIONEXPECTTEST", "0.2.1")
setenv("EBDEVELEXPECTTEST", pathJoin(root, "logs/expecttest-0.2.1-GCCcore-13.2.0-easybuild-devel"))
