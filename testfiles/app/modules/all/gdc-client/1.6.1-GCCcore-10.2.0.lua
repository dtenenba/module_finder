...
Included extensions
===================
cryptography-2.8, gdc-client-1.6.1, idna-2.8, intervaltree-3.0.2,
...
whatis([==[Extensions: cryptography-2.8, gdc-client-1.6.1, idna-2.8, intervaltree-3.0.2, jsonschema-2.6.0, lxml-4.4.2, ndg-httpsclient-0.5.0, progressbar2-3.43.1, pyasn1-0.4.3, pyOpenSSL-18.0.0, python-utils-2.5.6, PyYAML-3.13, requests-2.22.0, termcolor-1.1.0]==])

local root = "/app/software/gdc-client/1.6.1-GCCcore-10.2.0"
...
setenv("EBVERSIONGDCMINCLIENT", "1.6.1")
setenv("EBDEVELGDCMINCLIENT", pathJoin(root, "logs/gdc-client-1.6.1-GCCcore-10.2.0-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.8/site-packages"))
-- Built with EasyBuild version 4.5.0
setenv("EBEXTSLISTGDCMINCLIENT", "cryptography-2.8,jsonschema-2.6.0,lxml-4.4.2,ndg-httpsclient-0.5.0,pyasn1-0.4.3,pyOpenSSL-18.0.0,PyYAML-3.13,intervaltree-3.0.2,termcolor-1.1.0,idna-2.8,requests-2.22.0,python-utils-2.5.6,progressbar2-3.43.1,gdc-client-1.6.1")
