...
local root = "/app/software/Boost/1.64.0-gompi-2019b"
...
setenv("EBVERSIONBOOST", "1.64.0")
setenv("EBDEVELBOOST", pathJoin(root, "logs/Boost-1.64.0-gompi-2019b-easybuild-devel"))

setenv("BOOST_ROOT", "/app/software/Boost/1.64.0-gompi-2019b")
