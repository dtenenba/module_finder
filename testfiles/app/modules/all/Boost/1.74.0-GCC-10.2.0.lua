...
local root = "/app/software/Boost/1.74.0-GCC-10.2.0"
...
setenv("EBDEVELBOOST", pathJoin(root, "logs/Boost-1.74.0-GCC-10.2.0-easybuild-devel"))

setenv("BOOST_ROOT", "/app/software/Boost/1.74.0-GCC-10.2.0")
