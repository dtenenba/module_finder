...
local root = "/app/software/Boost/1.55.0-GCC-11.2.0"
...
setenv("EBDEVELBOOST", pathJoin(root, "logs/Boost-1.55.0-GCC-11.2.0-easybuild-devel"))

setenv("BOOST_ROOT", "/app/software/Boost/1.55.0-GCC-11.2.0")
