...
local root = "/app/software/Boost/1.81.0-GCCcore-12.2.0"
...
setenv("EBDEVELBOOST", pathJoin(root, "logs/Boost-1.81.0-GCCcore-12.2.0-easybuild-devel"))

setenv("BOOST_ROOT", "/app/software/Boost/1.81.0-GCCcore-12.2.0")
