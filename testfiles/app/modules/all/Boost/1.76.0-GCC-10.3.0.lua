...
local root = "/app/software/Boost/1.76.0-GCC-10.3.0"
...
if not ( isloaded("ICU/69.1-GCCcore-10.3.0") ) then
    load("ICU/69.1-GCCcore-10.3.0")
end
...
setenv("EBDEVELBOOST", pathJoin(root, "logs/Boost-1.76.0-GCC-10.3.0-easybuild-devel"))

setenv("BOOST_ROOT", "/app/software/Boost/1.76.0-GCC-10.3.0")
