...
local root = "/app/software/FFmpeg/4.4.2-GCCcore-11.3.0"
...
if not ( isloaded("x264/20220620-GCCcore-11.3.0") ) then
    load("x264/20220620-GCCcore-11.3.0")
end
...
if not ( isloaded("x265/3.5-GCCcore-11.3.0") ) then
    load("x265/3.5-GCCcore-11.3.0")
end
...
setenv("EBVERSIONFFMPEG", "4.4.2")
setenv("EBDEVELFFMPEG", pathJoin(root, "logs/FFmpeg-4.4.2-GCCcore-11.3.0-easybuild-devel"))
