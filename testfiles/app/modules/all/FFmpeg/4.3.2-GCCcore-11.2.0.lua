...
local root = "/app/software/FFmpeg/4.3.2-GCCcore-11.2.0"
...
if not ( isloaded("x264/20210613-GCCcore-11.2.0") ) then
    load("x264/20210613-GCCcore-11.2.0")
end

if not ( isloaded("LAME/3.100-GCCcore-11.2.0") ) then
    load("LAME/3.100-GCCcore-11.2.0")
end

if not ( isloaded("x265/3.5-GCCcore-11.2.0") ) then
    load("x265/3.5-GCCcore-11.2.0")
end
...
setenv("EBDEVELFFMPEG", pathJoin(root, "logs/FFmpeg-4.3.2-GCCcore-11.2.0-easybuild-devel"))
