...
local root = "/app/software/FFmpeg/4.2.1-GCCcore-8.3.0"
...
if not ( isloaded("x264/20190925-GCCcore-8.3.0") ) then
    load("x264/20190925-GCCcore-8.3.0")
end

if not ( isloaded("LAME/3.100-GCCcore-8.3.0") ) then
    load("LAME/3.100-GCCcore-8.3.0")
end

if not ( isloaded("x265/3.2-GCCcore-8.3.0") ) then
    load("x265/3.2-GCCcore-8.3.0")
end
...
setenv("EBVERSIONFFMPEG", "4.2.1")
setenv("EBDEVELFFMPEG", pathJoin(root, "logs/FFmpeg-4.2.1-GCCcore-8.3.0-easybuild-devel"))
