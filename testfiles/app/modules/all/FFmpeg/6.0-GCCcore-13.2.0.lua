...
local root = "/app/software/FFmpeg/6.0-GCCcore-13.2.0"
...
if not ( isloaded("x264/20231019-GCCcore-13.2.0") ) then
    load("x264/20231019-GCCcore-13.2.0")
end

if not ( isloaded("LAME/3.100-GCCcore-13.2.0") ) then
    load("LAME/3.100-GCCcore-13.2.0")
end

if not ( isloaded("x265/3.5-GCCcore-13.2.0") ) then
    load("x265/3.5-GCCcore-13.2.0")
end
...
if not ( isloaded("SDL2/2.28.5-GCCcore-13.2.0") ) then
    load("SDL2/2.28.5-GCCcore-13.2.0")
end
...
setenv("EBDEVELFFMPEG", pathJoin(root, "logs/FFmpeg-6.0-GCCcore-13.2.0-easybuild-devel"))
