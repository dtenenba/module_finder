...
local root = "/app/software/nlohmann_json/3.11.2-GCCcore-12.2.0"
...
setenv("EBDEVELNLOHMANN_JSON", pathJoin(root, "logs/nlohmann_json-3.11.2-GCCcore-12.2.0-easybuild-devel"))
