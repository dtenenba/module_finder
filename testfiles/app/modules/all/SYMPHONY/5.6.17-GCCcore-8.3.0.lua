...
local root = "/app/software/SYMPHONY/5.6.17-GCCcore-8.3.0"
...
if not ( isloaded("Cgl/0.60.3-GCCcore-8.3.0") ) then
    load("Cgl/0.60.3-GCCcore-8.3.0")
end
...
setenv("EBDEVELSYMPHONY", pathJoin(root, "logs/SYMPHONY-5.6.17-GCCcore-8.3.0-easybuild-devel"))
