...
local root = "/app/software/PostgreSQL/13.4-GCCcore-11.2.0"
...
setenv("EBVERSIONPOSTGRESQL", "13.4")
setenv("EBDEVELPOSTGRESQL", pathJoin(root, "logs/PostgreSQL-13.4-GCCcore-11.2.0-easybuild-devel"))
