...
local root = "/app/software/PostgreSQL/12.3-GCCcore-9.3.0-Python-3.8.2"
...
setenv("EBVERSIONPOSTGRESQL", "12.3")
setenv("EBDEVELPOSTGRESQL", pathJoin(root, "logs/PostgreSQL-12.3-GCCcore-9.3.0-Python-3.8.2-easybuild-devel"))
