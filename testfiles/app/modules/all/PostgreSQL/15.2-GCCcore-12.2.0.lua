...
local root = "/app/software/PostgreSQL/15.2-GCCcore-12.2.0"
...
setenv("EBVERSIONPOSTGRESQL", "15.2")
setenv("EBDEVELPOSTGRESQL", pathJoin(root, "logs/PostgreSQL-15.2-GCCcore-12.2.0-easybuild-devel"))
