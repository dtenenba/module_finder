...
local root = "/app/software/PostgreSQL/14.4-GCCcore-11.2.0"
...
setenv("EBVERSIONPOSTGRESQL", "14.4")
setenv("EBDEVELPOSTGRESQL", pathJoin(root, "logs/PostgreSQL-14.4-GCCcore-11.2.0-easybuild-devel"))
