...
local root = "/app/software/PostgreSQL/16.1-GCCcore-13.2.0"
...
setenv("EBVERSIONPOSTGRESQL", "16.1")
setenv("EBDEVELPOSTGRESQL", pathJoin(root, "logs/PostgreSQL-16.1-GCCcore-13.2.0-easybuild-devel"))
