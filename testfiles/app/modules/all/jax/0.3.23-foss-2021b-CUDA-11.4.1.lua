...
whatis([==[Extensions: etils-0.8.0, jax-0.3.23, opt_einsum-3.3.0]==])

local root = "/app/software/jax/0.3.23-foss-2021b-CUDA-11.4.1"
...
setenv("EBVERSIONJAX", "0.3.23")
setenv("EBDEVELJAX", pathJoin(root, "logs/jax-0.3.23-foss-2021b-CUDA-11.4.1-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.9/site-packages"))
-- Built with EasyBuild version 4.6.2
setenv("EBEXTSLISTJAX", "opt_einsum-3.3.0,etils-0.8.0,jax-0.3.23")
