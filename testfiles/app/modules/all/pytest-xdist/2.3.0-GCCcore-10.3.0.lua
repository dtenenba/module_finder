...
local root = "/app/software/pytest-xdist/2.3.0-GCCcore-10.3.0"
...
setenv("EBDEVELPYTESTMINXDIST", pathJoin(root, "logs/pytest-xdist-2.3.0-GCCcore-10.3.0-easybuild-devel"))
