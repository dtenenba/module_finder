...
local root = "/app/software/pytest-xdist/2.5.0-GCCcore-11.3.0"
...
setenv("EBDEVELPYTESTMINXDIST", pathJoin(root, "logs/pytest-xdist-2.5.0-GCCcore-11.3.0-easybuild-devel"))
