...
whatis([==[Extensions: apipkg-1.5, execnet-1.9.0, pytest-forked-1.3.0, pytest-xdist-2.3.0]==])

local root = "/app/software/pytest-xdist/2.3.0-GCCcore-10.2.0"
...
setenv("EBVERSIONPYTESTMINXDIST", "2.3.0")
setenv("EBDEVELPYTESTMINXDIST", pathJoin(root, "logs/pytest-xdist-2.3.0-GCCcore-10.2.0-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.8/site-packages"))
-- Built with EasyBuild version 4.3.4
setenv("EBEXTSLISTPYTESTMINXDIST", "apipkg-1.5,execnet-1.9.0,pytest-forked-1.3.0,pytest-xdist-2.3.0")
