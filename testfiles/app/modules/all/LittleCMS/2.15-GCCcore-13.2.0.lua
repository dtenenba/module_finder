...
local root = "/app/software/LittleCMS/2.15-GCCcore-13.2.0"
...
setenv("EBVERSIONLITTLECMS", "2.15")
setenv("EBDEVELLITTLECMS", pathJoin(root, "logs/LittleCMS-2.15-GCCcore-13.2.0-easybuild-devel"))
