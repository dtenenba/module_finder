...
local root = "/app/software/nextflow/20.04.0-edge"
...
setenv("EBVERSIONNEXTFLOW", "20.04.0-edge")
setenv("EBDEVELNEXTFLOW", pathJoin(root, "logs/nextflow-20.04.0-edge-easybuild-devel"))
