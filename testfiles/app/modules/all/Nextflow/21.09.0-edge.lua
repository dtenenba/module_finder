...
local root = "/app/software/nextflow/21.09.0-edge"
...
setenv("EBVERSIONNEXTFLOW", "21.09.0-edge")
setenv("EBDEVELNEXTFLOW", pathJoin(root, "logs/nextflow-21.09.0-edge-easybuild-devel"))
