...
local root = "/app/software/SDL2/2.28.2-GCCcore-12.3.0"
...
setenv("EBVERSIONSDL2", "2.28.2")
setenv("EBDEVELSDL2", pathJoin(root, "logs/SDL2-2.28.2-GCCcore-12.3.0-easybuild-devel"))
