...
local root = "/app/software/SDL2/2.0.10-GCCcore-8.3.0"
...
setenv("EBVERSIONSDL2", "2.0.10")
setenv("EBDEVELSDL2", pathJoin(root, "logs/SDL2-2.0.10-GCCcore-8.3.0-easybuild-devel"))
