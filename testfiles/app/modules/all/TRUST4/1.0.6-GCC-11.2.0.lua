...
local root = "/app/software/TRUST4/1.0.6-GCC-11.2.0"
...
setenv("EBVERSIONTRUST4", "1.0.6")
setenv("EBDEVELTRUST4", pathJoin(root, "logs/TRUST4-1.0.6-GCC-11.2.0-easybuild-devel"))
