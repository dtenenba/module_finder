...
local root = "/app/software/PLUMED/2.7.2-foss-2020b"
...
setenv("EBVERSIONPLUMED", "2.7.2")
setenv("EBDEVELPLUMED", pathJoin(root, "logs/PLUMED-2.7.2-foss-2020b-easybuild-devel"))
