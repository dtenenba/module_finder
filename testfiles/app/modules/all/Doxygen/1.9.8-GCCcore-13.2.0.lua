...
local root = "/app/software/Doxygen/1.9.8-GCCcore-13.2.0"
...
setenv("EBVERSIONDOXYGEN", "1.9.8")
setenv("EBDEVELDOXYGEN", pathJoin(root, "logs/Doxygen-1.9.8-GCCcore-13.2.0-easybuild-devel"))
