...
local root = "/app/software/cURL/7.76.0-GCCcore-10.3.0"
...
setenv("EBDEVELCURL", pathJoin(root, "logs/cURL-7.76.0-GCCcore-10.3.0-easybuild-devel"))

setenv("CURL_INCLUDES", "/app/software/cURL/7.76.0-GCCcore-10.3.0/include")
