...
local root = "/app/software/cURL/7.83.0-GCCcore-11.3.0"
...
setenv("EBDEVELCURL", pathJoin(root, "logs/cURL-7.83.0-GCCcore-11.3.0-easybuild-devel"))

setenv("CURL_INCLUDES", "/app/software/cURL/7.83.0-GCCcore-11.3.0/include")
