...
local root = "/app/software/cURL/7.86.0-GCCcore-12.2.0"
...
setenv("EBDEVELCURL", pathJoin(root, "logs/cURL-7.86.0-GCCcore-12.2.0-easybuild-devel"))

setenv("CURL_INCLUDES", "/app/software/cURL/7.86.0-GCCcore-12.2.0/include")
