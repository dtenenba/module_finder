...
local root = "/app/software/cURL/8.3.0-GCCcore-13.2.0"
...
setenv("EBDEVELCURL", pathJoin(root, "logs/cURL-8.3.0-GCCcore-13.2.0-easybuild-devel"))

setenv("CURL_INCLUDES", "/app/software/cURL/8.3.0-GCCcore-13.2.0/include")
