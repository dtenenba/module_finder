...
local root = "/app/software/googletest/1.11.0-GCCcore-11.2.0"
...
setenv("EBVERSIONGOOGLETEST", "1.11.0")
setenv("EBDEVELGOOGLETEST", pathJoin(root, "logs/googletest-1.11.0-GCCcore-11.2.0-easybuild-devel"))
