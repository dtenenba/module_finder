...
local root = "/app/software/Python/3.10.4-GCCcore-11.3.0"
...
if not ( isloaded("libreadline/8.1.2-GCCcore-11.3.0") ) then
    load("libreadline/8.1.2-GCCcore-11.3.0")
end

if not ( isloaded("ncurses/6.3-GCCcore-11.3.0") ) then
    load("ncurses/6.3-GCCcore-11.3.0")
end
...
if not ( isloaded("OpenSSL/1.1.1n-GCCcore-11.3.0") ) then
    load("OpenSSL/1.1.1n-GCCcore-11.3.0")
end
...
setenv("EBDEVELPYTHON", pathJoin(root, "logs/Python-3.10.4-GCCcore-11.3.0-easybuild-devel"))
