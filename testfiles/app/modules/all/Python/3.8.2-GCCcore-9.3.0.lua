...
idna-2.9, imagesize-1.2.0, importlib_metadata-1.6.0, ipaddress-1.0.23,
Jinja2-2.11.2, joblib-0.14.1, liac-arff-2.4.0, MarkupSafe-1.1.1, mock-4.0.1,
more-itertools-8.2.0, netaddr-0.7.19, netifaces-0.10.9, nose-1.3.7,
...
pyparsing-2.4.7, pytest-5.4.1, python-dateutil-2.8.1, pytz-2019.3,
requests-2.23.0, scandir-1.10.0, setuptools-45.2.0, setuptools_scm-3.5.0,
six-1.14.0, snowballstemmer-2.0.0, Sphinx-3.0.2, sphinxcontrib-
applehelp-1.0.2, sphinxcontrib-devhelp-1.0.2, sphinxcontrib-htmlhelp-1.0.3,
sphinxcontrib-jsmath-1.0.1, sphinxcontrib-qthelp-1.0.3, sphinxcontrib-
serializinghtml-1.1.4, sphinxcontrib-websupport-1.2.1, tabulate-0.8.7,
toml-0.10.0, ujson-2.0.3, urllib3-1.25.9, virtualenv-20.0.18, wcwidth-0.1.9,
wheel-0.34.2, xlrd-1.2.0, zipp-1.2.0
]==])
...
if not ( isloaded("SQLite/3.31.1-GCCcore-9.3.0") ) then
    load("SQLite/3.31.1-GCCcore-9.3.0")
end
...
if not ( isloaded("libffi/3.3-GCCcore-9.3.0") ) then
    load("libffi/3.3-GCCcore-9.3.0")
end
