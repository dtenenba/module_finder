...
local root = "/app/software/Blosc/1.21.1-GCCcore-11.2.0"
...
setenv("EBVERSIONBLOSC", "1.21.1")
setenv("EBDEVELBLOSC", pathJoin(root, "logs/Blosc-1.21.1-GCCcore-11.2.0-easybuild-devel"))
