...
local root = "/app/software/Blosc/1.21.5-GCCcore-12.3.0"
...
setenv("EBVERSIONBLOSC", "1.21.5")
setenv("EBDEVELBLOSC", pathJoin(root, "logs/Blosc-1.21.5-GCCcore-12.3.0-easybuild-devel"))
