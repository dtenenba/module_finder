...
local root = "/app/software/GST-plugins-base/1.18.5-GCC-11.2.0"
...
setenv("EBVERSIONGSTMINPLUGINSMINBASE", "1.18.5")
setenv("EBDEVELGSTMINPLUGINSMINBASE", pathJoin(root, "logs/GST-plugins-base-1.18.5-GCC-11.2.0-easybuild-devel"))
