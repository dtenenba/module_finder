...
local root = "/app/software/GST-plugins-base/1.18.3-GCC-10.2.0"
...
setenv("EBVERSIONGSTMINPLUGINSMINBASE", "1.18.3")
setenv("EBDEVELGSTMINPLUGINSMINBASE", pathJoin(root, "logs/GST-plugins-base-1.18.3-GCC-10.2.0-easybuild-devel"))
