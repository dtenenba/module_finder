...
Included extensions
===================
annoy-1.17.1, pynndescent-0.5.8, scrublet-0.2.3, umap-learn-0.5.3
]==])
...
whatis([==[Extensions: annoy-1.17.1, pynndescent-0.5.8, scrublet-0.2.3, umap-learn-0.5.3]==])

local root = "/app/software/scrublet/0.2.3-foss-2021b"
...
setenv("EBVERSIONSCRUBLET", "0.2.3")
setenv("EBDEVELSCRUBLET", pathJoin(root, "logs/scrublet-0.2.3-foss-2021b-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.9/site-packages"))
-- Built with EasyBuild version 4.6.2
setenv("EBEXTSLISTSCRUBLET", "annoy-1.17.1,pynndescent-0.5.8,umap-learn-0.5.3,scrublet-0.2.3")
