...
Included extensions
===================
annoy-1.17.3, pynndescent-0.5.10, scrublet-0.2.3
]==])
...
whatis([==[Extensions: annoy-1.17.3, pynndescent-0.5.10, scrublet-0.2.3]==])

local root = "/app/software/scrublet/0.2.3-foss-2022b"
...
setenv("EBDEVELSCRUBLET", pathJoin(root, "logs/scrublet-0.2.3-foss-2022b-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib/python3.10/site-packages"))
-- Built with EasyBuild version 4.9.1
setenv("EBEXTSLISTSCRUBLET", "annoy-1.17.3,pynndescent-0.5.10,scrublet-0.2.3")
