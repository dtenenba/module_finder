...
local root = "/app/software/Pysam/0.18.0-GCC-11.2.0"
...
setenv("EBVERSIONPYSAM", "0.18.0")
setenv("EBDEVELPYSAM", pathJoin(root, "logs/Pysam-0.18.0-GCC-11.2.0-easybuild-devel"))
