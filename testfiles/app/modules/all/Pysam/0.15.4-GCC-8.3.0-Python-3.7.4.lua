...
local root = "/app/software/Pysam/0.15.4-GCC-8.3.0-Python-3.7.4"
...
setenv("EBVERSIONPYSAM", "0.15.4")
setenv("EBDEVELPYSAM", pathJoin(root, "logs/Pysam-0.15.4-GCC-8.3.0-Python-3.7.4-easybuild-devel"))
