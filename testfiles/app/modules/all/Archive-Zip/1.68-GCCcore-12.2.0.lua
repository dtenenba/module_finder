...
local root = "/app/software/Archive-Zip/1.68-GCCcore-12.2.0"
...
if not ( isloaded("Zip/3.0-GCCcore-12.2.0") ) then
    load("Zip/3.0-GCCcore-12.2.0")
end
...
setenv("EBDEVELARCHIVEMINZIP", pathJoin(root, "logs/Archive-Zip-1.68-GCCcore-12.2.0-easybuild-devel"))
