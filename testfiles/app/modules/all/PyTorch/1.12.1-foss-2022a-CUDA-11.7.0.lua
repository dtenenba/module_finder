...
local root = "/app/software/PyTorch/1.12.1-foss-2022a-CUDA-11.7.0"
...
setenv("EBVERSIONPYTORCH", "1.12.1")
setenv("EBDEVELPYTORCH", pathJoin(root, "logs/PyTorch-1.12.1-foss-2022a-CUDA-11.7.0-easybuild-devel"))
