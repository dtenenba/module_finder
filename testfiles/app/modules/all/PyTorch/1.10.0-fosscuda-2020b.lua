...
local root = "/app/software/PyTorch/1.10.0-fosscuda-2020b"
...
if not ( isloaded("expecttest/0.1.3-GCCcore-10.2.0") ) then
    load("expecttest/0.1.3-GCCcore-10.2.0")
end
...
if not ( isloaded("magma/2.5.4-fosscuda-2020b") ) then
    load("magma/2.5.4-fosscuda-2020b")
end
...
setenv("EBDEVELPYTORCH", pathJoin(root, "logs/PyTorch-1.10.0-fosscuda-2020b-easybuild-devel"))
