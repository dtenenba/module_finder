...
local root = "/app/software/OpenMPI/4.0.3-GCC-9.3.0"
...
if not ( isloaded("hwloc/2.2.0-GCCcore-9.3.0") ) then
    load("hwloc/2.2.0-GCCcore-9.3.0")
end

if not ( isloaded("UCX/1.8.0-GCCcore-9.3.0") ) then
    load("UCX/1.8.0-GCCcore-9.3.0")
end
...
setenv("EBDEVELOPENMPI", pathJoin(root, "logs/OpenMPI-4.0.3-GCC-9.3.0-easybuild-devel"))
