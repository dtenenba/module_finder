...
local root = "/app/software/OpenMPI/4.0.5-gcccuda-2020b"
...
if not ( isloaded("UCX/1.9.0-GCCcore-10.2.0-CUDA-11.1.1") ) then
    load("UCX/1.9.0-GCCcore-10.2.0-CUDA-11.1.1")
end
...
setenv("EBDEVELOPENMPI", pathJoin(root, "logs/OpenMPI-4.0.5-gcccuda-2020b-easybuild-devel"))
