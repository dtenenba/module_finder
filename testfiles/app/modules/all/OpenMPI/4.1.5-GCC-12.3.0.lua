...
local root = "/app/software/OpenMPI/4.1.5-GCC-12.3.0"
...
if not ( isloaded("libfabric/1.18.0-GCCcore-12.3.0") ) then
    load("libfabric/1.18.0-GCCcore-12.3.0")
end

if not ( isloaded("PMIx/4.2.4-GCCcore-12.3.0") ) then
    load("PMIx/4.2.4-GCCcore-12.3.0")
end

if not ( isloaded("UCC/1.2.0-GCCcore-12.3.0") ) then
    load("UCC/1.2.0-GCCcore-12.3.0")
end
...
setenv("EBDEVELOPENMPI", pathJoin(root, "logs/OpenMPI-4.1.5-GCC-12.3.0-easybuild-devel"))
