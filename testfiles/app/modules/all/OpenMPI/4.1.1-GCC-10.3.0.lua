...
local root = "/app/software/OpenMPI/4.1.1-GCC-10.3.0"
...
if not ( isloaded("libevent/2.1.12-GCCcore-10.3.0") ) then
    load("libevent/2.1.12-GCCcore-10.3.0")
end
...
if not ( isloaded("libfabric/1.12.1-GCCcore-10.3.0") ) then
    load("libfabric/1.12.1-GCCcore-10.3.0")
end

if not ( isloaded("PMIx/3.2.3-GCCcore-10.3.0") ) then
    load("PMIx/3.2.3-GCCcore-10.3.0")
end
...
setenv("EBDEVELOPENMPI", pathJoin(root, "logs/OpenMPI-4.1.1-GCC-10.3.0-easybuild-devel"))
