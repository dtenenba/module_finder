...
local root = "/app/software/OpenMPI/4.1.4-GCC-11.3.0"
...
if not ( isloaded("libevent/2.1.12-GCCcore-11.3.0") ) then
    load("libevent/2.1.12-GCCcore-11.3.0")
end
...
if not ( isloaded("libfabric/1.15.1-GCCcore-11.3.0") ) then
    load("libfabric/1.15.1-GCCcore-11.3.0")
end

if not ( isloaded("PMIx/4.1.2-GCCcore-11.3.0") ) then
    load("PMIx/4.1.2-GCCcore-11.3.0")
end

if not ( isloaded("UCC/1.0.0-GCCcore-11.3.0") ) then
    load("UCC/1.0.0-GCCcore-11.3.0")
end
...
setenv("EBDEVELOPENMPI", pathJoin(root, "logs/OpenMPI-4.1.4-GCC-11.3.0-easybuild-devel"))
