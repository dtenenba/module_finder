...
local root = "/app/software/HDF/4.2.15-GCCcore-12.2.0"
...
if not ( isloaded("libtirpc/1.3.3-GCCcore-12.2.0") ) then
    load("libtirpc/1.3.3-GCCcore-12.2.0")
end
...
setenv("EBDEVELHDF", pathJoin(root, "logs/HDF-4.2.15-GCCcore-12.2.0-easybuild-devel"))
