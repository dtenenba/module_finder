...
local root = "/app/software/RSeQC/4.0.0-foss-2021b"
...
setenv("EBVERSIONRSEQC", "4.0.0")
setenv("EBDEVELRSEQC", pathJoin(root, "logs/RSeQC-4.0.0-foss-2021b-easybuild-devel"))
