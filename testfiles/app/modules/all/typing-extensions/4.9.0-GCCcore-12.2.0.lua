...
local root = "/app/software/typing-extensions/4.9.0-GCCcore-12.2.0"
...
setenv("EBDEVELTYPINGMINEXTENSIONS", pathJoin(root, "logs/typing-extensions-4.9.0-GCCcore-12.2.0-easybuild-devel"))
