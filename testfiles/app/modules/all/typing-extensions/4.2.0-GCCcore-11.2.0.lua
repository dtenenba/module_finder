...
local root = "/app/software/typing-extensions/4.2.0-GCCcore-11.2.0"
...
setenv("EBVERSIONTYPINGMINEXTENSIONS", "4.2.0")
setenv("EBDEVELTYPINGMINEXTENSIONS", pathJoin(root, "logs/typing-extensions-4.2.0-GCCcore-11.2.0-easybuild-devel"))
