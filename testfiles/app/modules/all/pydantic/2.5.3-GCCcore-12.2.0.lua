...
local root = "/app/software/pydantic/2.5.3-GCCcore-12.2.0"
...
if not ( isloaded("typing-extensions/4.9.0-GCCcore-12.2.0") ) then
    load("typing-extensions/4.9.0-GCCcore-12.2.0")
end
...
setenv("EBDEVELPYDANTIC", pathJoin(root, "logs/pydantic-2.5.3-GCCcore-12.2.0-easybuild-devel"))
