...
local root = "/app/software/Beast/2.6.3-GCC-10.2.0"
...
setenv("EBVERSIONBEAST", "2.6.3")
setenv("EBDEVELBEAST", pathJoin(root, "logs/Beast-2.6.3-GCC-10.2.0-easybuild-devel"))
