...
local root = "/app/software/Beast/2.6.2-GCCcore-8.3.0"
...
setenv("EBVERSIONBEAST", "2.6.2")
setenv("EBDEVELBEAST", pathJoin(root, "logs/Beast-2.6.2-GCCcore-8.3.0-easybuild-devel"))
