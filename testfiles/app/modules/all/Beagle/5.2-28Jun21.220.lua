...
local root = "/app/software/Beagle/5.2-28Jun21.220"
...
prepend_path("CLASSPATH", pathJoin(root, "beagle.28Jun21.220.jar"))
prepend_path("CMAKE_PREFIX_PATH", root)
setenv("EBROOTBEAGLE", root)
setenv("EBVERSIONBEAGLE", "5.2")
setenv("EBDEVELBEAGLE", pathJoin(root, "logs/Beagle-5.2-28Jun21.220-easybuild-devel"))
