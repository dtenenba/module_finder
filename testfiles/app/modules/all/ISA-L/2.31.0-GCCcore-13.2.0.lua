...
local root = "/app/software/ISA-L/2.31.0-GCCcore-13.2.0"
...
setenv("EBVERSIONISAMINL", "2.31.0")
setenv("EBDEVELISAMINL", pathJoin(root, "logs/ISA-L-2.31.0-GCCcore-13.2.0-easybuild-devel"))
