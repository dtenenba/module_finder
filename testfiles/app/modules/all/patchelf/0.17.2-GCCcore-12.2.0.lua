...
local root = "/app/software/patchelf/0.17.2-GCCcore-12.2.0"
...
setenv("EBVERSIONPATCHELF", "0.17.2")
setenv("EBDEVELPATCHELF", pathJoin(root, "logs/patchelf-0.17.2-GCCcore-12.2.0-easybuild-devel"))
