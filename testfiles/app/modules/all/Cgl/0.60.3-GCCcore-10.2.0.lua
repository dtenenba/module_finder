...
local root = "/app/software/Cgl/0.60.3-GCCcore-10.2.0"
...
if not ( isloaded("Clp/1.17.6-GCCcore-10.2.0") ) then
    load("Clp/1.17.6-GCCcore-10.2.0")
end
...
setenv("EBDEVELCGL", pathJoin(root, "logs/Cgl-0.60.3-GCCcore-10.2.0-easybuild-devel"))
