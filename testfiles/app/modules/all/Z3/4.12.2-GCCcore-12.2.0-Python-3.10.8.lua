...
local root = "/app/software/Z3/4.12.2-GCCcore-12.2.0-Python-3.10.8"
...
setenv("EBDEVELZ3", pathJoin(root, "logs/Z3-4.12.2-GCCcore-12.2.0-Python-3.10.8-easybuild-devel"))
