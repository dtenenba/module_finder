...
local root = "/app/software/Mesa/19.2.1-GCCcore-8.3.0"
...
setenv("EBVERSIONMESA", "19.2.1")
setenv("EBDEVELMESA", pathJoin(root, "logs/Mesa-19.2.1-GCCcore-8.3.0-easybuild-devel"))
